...
import kmade.kmade.UI.toolutilities.KMADEMoreButton;
...
public class KMADESimulationToolBar extends JPanel implements LanguageFactory {
    ...
    public KMADESimulationToolBar() {
        ...
        // Zoom global
        globalGraphAction = new AbstractAction("", KMADETaskModelToolBar.ZOOM_GLOBAL_ICON) {
            private static final long serialVersionUID = 4000465475546408455L;
            public void actionPerformed(ActionEvent e) {
                SimulationAdaptator.setGlobalTaskModel();
            }
        };
        globalGraphAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.ZOOM_GLOBAL_ACTION_MESSAGE);
        ...
        editUserValues.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.EDIT_USER_VALUES_SIMULATION_MESSAGE);
        ...
        myShowOrNotTaskLabelAction = new JToggleButton(myShowOrNotTaskLabelToggleAction);               
        ...
        myShowOrNotTaskColorLabelAction = new JToggleButton(myShowOrNotTaskColorLabelToggleAction);
