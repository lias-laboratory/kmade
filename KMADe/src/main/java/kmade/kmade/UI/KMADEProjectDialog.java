...
public class KMADEProjectDialog extends JDialog implements LanguageFactory {
    ...
    public KMADEProjectDialog(Frame owner) {
        ...
        panelIntDescription.setBorder(BorderFactory.createEmptyBorder(10,10,10,10));
        myTitledBorder = BorderFactory.createTitledBorder(KMADEConstant.GENERAL_DESCRIPTION_PROJECT_DIALOG_TITLE + " :");
        ...
        String[] columnNames = {KMADEConstant.INTERVIEWED_NAME_TABLE, KMADEConstant.PLACE_INFORMATION_TABLE,
                KMADEConstant.STATUT_TABLE, KMADEConstant.SENIORITY_TABLE, KMADEConstant.DATE_TABLE, KMADEConstant.INTERVIEW_TYPE_TABLE,
                KMADEConstant.SEARCHED_INFORMATIONS_TABLE, KMADEConstant.INTERVIEW_NAME_TABLE};   
        myTableListModel = new MyTableListModel(columnNames,KMADEConstant.INTERVIEW_NEW_OBJECT_TABLE);
        ...
        myTitledBorderInterviewed = BorderFactory.createTitledBorder(KMADEConstant.INTERVIEWED_DESCRIPTION_PROJECT_DIALOG_TITLE + " :"); 
        ...
        myTitledBorderJustification = BorderFactory.createTitledBorder(KMADEConstant.JUSTIFICATION_PROJECT_DIALOG_TITLE + " :");
        ...
        okButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                ProjectManagerAdaptator.confirmModification(temp, myTableListModel.getListTableData());
            }
        });
    ...
    public void showToModifyProjectData(String[] data, ArrayList<Object[]> interview) {
    ...
    class MyKeyListener extends KeyAdapter {
        public void keyPressed(KeyEvent ke) {
            if (ke.getKeyCode() == KeyEvent.VK_DELETE) {
                ...
                boolean state = GraphicEditorAdaptator.removeSelectedItem("Project",r,myTableListModel.getListTableData(), KMADEProjectDialog.this, KMADEConstant.REMOVE_INTERVIEW_MESSAGE_TITLE);
    ...
    public void notifLocalisationModification() {      
        ...
        myTableListModel.setNameDefault(KMADEConstant.INTERVIEW_NEW_OBJECT_TABLE);
        myTitledBorder.setTitle(KMADEConstant.GENERAL_DESCRIPTION_PROJECT_DIALOG_TITLE + " :");
        ...
        myTitledBorderInterviewed.setTitle(KMADEConstant.INTERVIEWED_DESCRIPTION_PROJECT_DIALOG_TITLE + " :");
        myTitledBorderJustification.setTitle(KMADEConstant.JUSTIFICATION_PROJECT_DIALOG_TITLE + " :");
    }
}
