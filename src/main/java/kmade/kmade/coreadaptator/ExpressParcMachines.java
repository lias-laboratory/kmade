...
public class ExpressParcMachines{
	...
	public static Object[][] getMachineNotAddIntoTab(String oid) {
		...
		for(int i =0;i<tabMach.length;i++){
			// on regarde si l'Machine appartient au ParcMachines, si non on l'ajoute � notre r�sultat
		...
		return res;
			...
			//s'il n'y a pas d'oid ou un oid �rron� on renvoi un tableau sans ligne
