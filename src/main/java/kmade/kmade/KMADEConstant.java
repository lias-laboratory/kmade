...
public class KMADEConstant {
	...
	// Les mots affiché sur une tâche dans l'espace de tâche
	...
	public static String SAME_NAME_TITLE = "Le nom est déjà utilisé, renommer en :";
	// Abstract Object
	...
	public static String ACTOR_EXPERIENCE_TABLE = "Expérience";
	...
	public static String MEDIA_START_TAG = "Repère départ (m:s)";
	...
	public static String JUSTIFICATION_PROJECT_DIALOG_TITLE = "Justification de l'étude de cas (en quoi ce cas reflète un probléme de charge)";
	...
	public static String OPEN_SIMULATION_MESSAGE = "Lancement de la boîte de dialogue de simulation";
	...
	public static String SCENARIO_FILTER_NAME = "Fichier de scénario" + " (" + KMADE_SCENARIO_EXTENSION_FILE + ")";
	...
	public static String EXECUTE_TASK_TRAITEMENT_MESSAGE = "Traitement de la tâche";
	...
	public static String USER_VALUES_PROBLEM_MESSAGE = "Problème Valeurs Utilisateur";
	...
	public static String FINISHED_RECORD_SIMULATION_MESSAGE = "Simulation du modèle de tâches K-MAD terminée : scénario disponible ...";
	...
	public static String JAVA_GRAPHIC_LIBRARIES_MESSAGE = "Bibliothèques Utilisées";
	...
	//
	// Les constantes liées aux images
	//
	...
	public static final String OPTIONAL_INTERACTIF_TASK_IMAGE = KMADEToolConstant.IMAGE_DIRECTORY_NAME + "ointeraction.png";
	...
	public static final String EVENEMENT_IN_IMAGE_DISABLE = KMADEToolConstant.IMAGE_DIRECTORY_NAME + "evenement_in_disable.png";
	public static final String EVENEMENT_OUT_IMAGE_DISABLE = KMADEToolConstant.IMAGE_DIRECTORY_NAME + "evenement_out_disable.png";
	...
	public static final String LISI_LOGO_IMAGE = KMADEToolConstant.IMAGE_DIRECTORY_NAME + "lisi.gif";
	...
	public static final String GO_SIMULATION_SCENARIO_IMAGE = KMADEToolConstant.IMAGE_DIRECTORY_NAME + "gosimulation.png";
	...
	//
	// Les constantes liées aux templates de Velocity
	//
	public static final String DEFAULT_CARD_VELOCITY_HTML = KMADEToolConstant.VELOCITY_TEMPLATE_DIRECTORY_NAME + "default.vm";   
	public static final String BASIC_CARD_VELOCITY_HTML = KMADEToolConstant.VELOCITY_TEMPLATE_DIRECTORY_NAME + "basic.vm";

	//
	// Les constantes liées aux autres resources
	//
	...
	public static String NOT_SAME_VERSION = "La version que vous essayé de charger n'est pas la même que celle de l'outil";
	...
	public static void loadMessagesFromBundle() { 
		...
		UNDER_DEVELOPMENT_START_HTML = KMADEToolConstant.HTML_DIRECTORY_NAME + KMADeMain.messages.getString("UNDER_DEVELOPMENT_START_HTML");    	
		...
		CONCRETE_TASK_OBJECT_TABBEDPANE_TITLE_NAME = KMADeMain.messages.getString("CONCRETE_TASK_OBJECT_TABBEDPANE_TITLE_NAME");
		...
		INDIVIDU_DISPLAY_BAD_PATH_IMAGE_MESSAGE = KMADeMain.messages.getString("INDIVIDU_DISPLAY_BAD_PATH_IMAGE_MESSAGE");
		...
		ORGANIZATION_DISPLAY_PATH_IMAGE_MESSAGE = KMADeMain.messages.getString("ORGANIZATION_DISPLAY_PATH_IMAGE_MESSAGE");
		ORGANIZATION_DISPLAY_DEFAULT_IMAGE_MESSAGE = KMADeMain.messages.getString("ORGANIZATION_DISPLAY_DEFAULT_IMAGE_MESSAGE");
		ORGANIZATION_DISPLAY_BAD_PATH_IMAGE_MESSAGE = KMADeMain.messages.getString("ORGANIZATION_DISPLAY_BAD_PATH_IMAGE_MESSAGE");
		...
		// ParcMachines
		 ...
		 PARCMACHINES_DISPLAY_PATH_IMAGE_MESSAGE = KMADeMain.messages.getString("PARCMACHINES_DISPLAY_PATH_IMAGE_MESSAGE");
		 PARCMACHINES_DISPLAY_DEFAULT_IMAGE_MESSAGE = KMADeMain.messages.getString("PARCMACHINES_DISPLAY_DEFAULT_IMAGE_MESSAGE");
		 PARCMACHINES_DISPLAY_BAD_PATH_IMAGE_MESSAGE = KMADeMain.messages.getString("PARCMACHINES_DISPLAY_BAD_PATH_IMAGE_MESSAGE");
		...
		GENERAL_INFORMATION_PANEL_LEGEND_TITLE_NAME = KMADeMain.messages.getString("GENERAL_INFORMATION_PANEL_LEGEND_TITLE_NAME");
		...
		GENERAL_DESCRIPTION_PROJECT_DIALOG_TITLE = KMADeMain.messages.getString("GENERAL_DESCRIPTION_PROJECT_DIALOG_TITLE");
		...
		INTERVIEWED_DESCRIPTION_PROJECT_DIALOG_TITLE = KMADeMain.messages.getString("INTERVIEWED_DESCRIPTION_PROJECT_DIALOG_TITLE");
		...
		XML_PARSER_MISSING_ELEMENT_PROBLEM_MESSAGE = KMADeMain.messages.getString("XML_PARSER_MISSING_ELEMENT_PROBLEM_MESSAGE");

		// Gestion du chargement
		OPEN_CANCELLED_EXPRESS_FILECHOOSER_NAME = KMADeMain.messages.getString("OPEN_CANCELLED_EXPRESS_FILECHOOSER_NAME");
		...
		EXPLICIT_STOP_LOAD_SPF_FILE_DURING_OBJECT = KMADeMain.messages.getString("EXPLICIT_STOP_LOAD_SPF_FILE_DURING_OBJECT");
		EXPLICIT_STOP_LOAD_SPF_FILE_DURING_GRAPHICAL_OBJECT = KMADeMain.messages.getString("EXPLICIT_STOP_LOAD_SPF_FILE_DURING_GRAPHICAL_OBJECT");

		// Gestion de la sauvegarde
		SAVE_CANCELLED_EXPRESS_FILECHOOSER_NAME = KMADeMain.messages.getString("SAVE_CANCELLED_EXPRESS_FILECHOOSER_NAME");
		...
		TASK_TREE_PANEL_LAYOUT_ORIENTATION_LABEL = KMADeMain.messages.getString("TASK_TREE_PANEL_LAYOUT_ORIENTATION_LABEL");
		TASK_TREE_PANEL_LAYOUT_DISTANCE_LABEL = KMADeMain.messages.getString("TASK_TREE_PANEL_LAYOUT_DISTANCE_LABEL");
		TASK_TREE_PANEL_LAYOUT_SELECTION_COLOR_LABEL = KMADeMain.messages.getString("TASK_TREE_PANEL_LAYOUT_SELECTION_COLOR_LABEL");
		TASK_TREE_PANEL_LAYOUT_LEVEL_DISTANCE_LABEL = KMADeMain.messages.getString("TASK_TREE_PANEL_LAYOUT_LEVEL_DISTANCE_LABEL");
		TASK_TREE_PANEL_OPTIONS_PANEL_NAME = KMADeMain.messages.getString("TASK_TREE_PANEL_OPTIONS_PANEL_NAME");
		TASK_TREE_PANEL_OPTIONS_ORTHOGONAL_EDGE_LABEL = KMADeMain.messages.getString("TASK_TREE_PANEL_OPTIONS_ORTHOGONAL_EDGE_LABEL");
		...
		EFFETSDEBORD_CONCRETE_OBJECT_TITLE_MESSAGE = KMADeMain.messages.getString("EFFETSDEBORD_CONCRETE_OBJECT_TITLE_MESSAGE");
		...
		REGULAR_EXPRESSIONS_OPTIONS_FIND_MESSAGE = KMADeMain.messages.getString("REGULAR_EXPRESSIONS_OPTIONS_FIND_MESSAGE");
		...
		TASK_NOT_FOUNDED_ACCORDING_FIND_CRITERIAS = KMADeMain.messages.getString("TASK_NOT_FOUNDED_ACCORDING_FIND_CRITERIAS");
		...
		OPEN_CANCELLED_SCENARIO_FILECHOOSER_NAME = KMADeMain.messages.getString("OPEN_CANCELLED_SCENARIO_FILECHOOSER_NAME");
		SAVE_CANCELLED_SCENARIO_FILECHOOSER_NAME = KMADeMain.messages.getString("SAVE_CANCELLED_SCENARIO_FILECHOOSER_NAME");
		...
		NO_SELECTED_ACTION_FOR_CONSTRAINTS_MESSAGE = KMADeMain.messages.getString("NO_SELECTED_ACTION_FOR_CONSTRAINTS_MESSAGE");
		NO_SELECTED_SCENARIO_ACTION_FOR_CONSTRAINTS_MESSAGE = KMADeMain.messages.getString("NO_SELECTED_SCENARIO_ACTION_FOR_CONSTRAINTS_MESSAGE");
		...
		PRECONDITION_CONSTRAINTS_RESPECTED_STATE_MESSAGE = KMADeMain.messages.getString("PRECONDITION_CONSTRAINTS_RESPECTED_STATE_MESSAGE");
		PRECONDITION_CONSTRAINTS_NO_RESPECTED_STATE_MESSAGE = KMADeMain.messages.getString("PRECONDITION_CONSTRAINTS_NO_RESPECTED_STATE_MESSAGE");
		PRECONDITION_CONSTRAINTS_ERROR_STATE_MESSAGE = KMADeMain.messages.getString("PRECONDITION_CONSTRAINTS_ERROR_STATE_MESSAGE");
		PRECONDITION_CONSTRAINTS_NEED_VALUES_STATE_MESSAGE = KMADeMain.messages.getString("PRECONDITION_CONSTRAINTS_NEED_VALUES_STATE_MESSAGE");
		...
		FINISHED_SCENARIO_AND_SIMULATION_PROBLEM_MESSAGE = KMADeMain.messages.getString("FINISHED_SCENARIO_AND_SIMULATION_PROBLEM_MESSAGE");
		...
		ACTIVE_ITERATION_STATE_TASK_SIMULATION_MESSAGE = KMADeMain.messages.getString("ACTIVE_ITERATION_STATE_TASK_SIMULATION_MESSAGE");
		...
		NO_ACCESSIBLE_STATE_TASK_SIMULATION_MESSAGE = KMADeMain.messages.getString("NO_ACCESSIBLE_STATE_TASK_SIMULATION_MESSAGE");
		PASSED_STATE_TASK_SIMULATION_MESSAGE = KMADeMain.messages.getString("PASSED_STATE_TASK_SIMULATION_MESSAGE");
		SUSPENDED_STATE_TASK_SIMULATION_MESSAGE = KMADeMain.messages.getString("SUSPENDED_STATE_TASK_SIMULATION_MESSAGE");
		NO_RESUMED_STATE_TASK_SIMULATION_MESSAGE = KMADeMain.messages.getString("NO_RESUMED_STATE_TASK_SIMULATION_MESSAGE");
		...
		NO_SELECTED_TASK_BEFORE_RECORD_SIMULATION_MESSAGE = KMADeMain.messages.getString("NO_SELECTED_TASK_BEFORE_RECORD_SIMULATION_MESSAGE");
		...
		NO_FOUNDED_TASK_TO_REPLAY_PROBLEM_MESSAGE = KMADeMain.messages.getString("NO_FOUNDED_TASK_TO_REPLAY_PROBLEM_MESSAGE");
		CAN_NOT_EXECUTE_TASK_TO_REPLAY_PROBLEM_MESSAGE = KMADeMain.messages.getString("CAN_NOT_EXECUTE_TASK_TO_REPLAY_PROBLEM_MESSAGE");
		...
		PRECONDITION_EXPRESSION_MESSAGE_PROBLEM = KMADeMain.messages.getString("PRECONDITION_EXPRESSION_MESSAGE_PROBLEM");
		EFFETSDEBORD_EXPRESSION_MESSAGE_PROBLEM = KMADeMain.messages.getString("EFFETSDEBORD_EXPRESSION_MESSAGE_PROBLEM");
		...
		NO_DECOMPOSITION_SPECIFIED_MESSAGE_PROBLEM = KMADeMain.messages.getString("NO_DECOMPOSITION_SPECIFIED_MESSAGE_PROBLEM");
		...
		SUBTASKS_EXECUTANT_DIFFERENT_MESSAGE_WARNING = KMADeMain.messages.getString("SUBTASKS_EXECUTANT_DIFFERENT_MESSAGE_WARNING");
