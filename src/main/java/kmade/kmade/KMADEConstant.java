...
public class KMADEConstant {
	...
	public static final Color ACTIVE_SELECTION = Color.green;
	...
	public static String USER_TABBEDPANE_TITLE_NAME = "Utilisateurs";
	...
	// Effets d'une tâche
	public static String EFFECT_PANEL_TITLE_NAME = "Actions";
	public static String POSTCONDITION_LABEL_VALUE = "Postcondition";
	public static String POSTCONDITION_LABEL_LEGEND_VALUE = "Postcondition";
	...
	public static String SIDE_EFFECT_TITLE_NAME = "Effets de bord";
	...
	// Noms de langues
	public static String FRENCH_LANGUAGE = "Francais";
	public static String ENGLISH_LANGUAGE = "Anglais";
	...
	public static String EDITOR_POST_TITLE_NAME = "Editeur Postcondition";
	...
	public static String CHECK_ALL_POSTCONDITIONS = "Vérification des postconditions ...";
	public static String POSTCONDITION_OK_MESSAGE = "postcondition correcte";
	public static String POSTCONDITION_NO_OK_MESSAGE = "postcondition non correcte";
	public static String POSTCONDITION_EVAL_OK_MESSAGE = "postcondition évaluée et modèle K-MAD modifié";
	public static String POSTCONDITION_EVAL_NO_OK_MESSAGE = "postcondition non évaluée";
	public static String POSTCONDITION_OF_TASK_OK_MESSAGE = "Postcondition correcte pour la tâche";
	public static String POSTCONDITION_OF_TASK_NO_OK_MESSAGE = "Postcondition incorrecte pour la tâche";
	public static String POSTCONDITION_ERROR_MESSAGE = "Erreur sur la postcondition";
	public static String NOT_YET_CHECKED_POSTCONDITION_MESSAGE = "Postcondition non vérifiée";
	public static String POSTCONDITION_CHECKED_AND_BUILT_MESSAGE = "Vérification et création des postconditions terminées";
	public static String POSTCONDITION_PROGRESSBAR_MESSAGE = "Vérification et construction des postconditions";
	public static String POSTCONDITION_CONCRETE_OBJECT_TITLE_MESSAGE = "Objet Concret";
	public static String POSTCONDITION_HISTORY_TITLE_MESSAGE = "Historique de K-MAD";
	public static String POSTCONDITION_LOAD_STATE_MESSAGE = "Charger";
	...
	public static String POSTCONDITION_EDITION_MESSAGE = "Edition de la postcondition";
	...
	public static String POSTCONDITION_TEXTUEL_EDITION_MESSAGE = "Edition textuelle de la postcondition";
	...
	public static String POSTCONDITION_EXECUTED_STATE_MESSAGE = "Exécutée";
	public static String POSTCONDITION_NO_EXECUTED_STATE_MESSAGE = "Non Exécutée";
	...
	public static String POSTCONDITION_USER_EDITION_MESSAGE = "Valeurs utilisateur de la postcondition";
	...
	public static String POSTCONDITION_CONSTRAINT_MESSAGE = "Postcondition";
	...
	public static String POSTCONDITION_EXPRESSION_MESSAGE_PROBLEM = "Problème dans l'expression de la postcondition";
	...
	public static String POSTCONDITION_LOCATION_MESSAGE = "Postcondition";
	...
	public static void loadMessagesFromBundle() {
		...
		// Effets d'une tâche
		EFFECT_PANEL_TITLE_NAME = KMADeMain.messages
				.getString("EFFECT_PANEL_TITLE_NAME");
		POSTCONDITION_LABEL_VALUE = KMADeMain.messages
				.getString("POSTCONDITION_LABEL_VALUE");
		POSTCONDITION_LABEL_LEGEND_VALUE = KMADeMain.messages
				.getString("POSTCONDITION_LABEL_LEGEND_VALUE");
		...
		SIDE_EFFECT_TITLE_NAME = KMADeMain.messages
				.getString("SIDE_EFFECT_TITLE_NAME");
		...
		CHECK_ALL_POSTCONDITIONS = KMADeMain.messages
				.getString("CHECK_ALL_POSTCONDITIONS");
		POSTCONDITION_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_OK_MESSAGE");
		POSTCONDITION_NO_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_NO_OK_MESSAGE");
		POSTCONDITION_EVAL_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_EVAL_OK_MESSAGE");
		POSTCONDITION_EVAL_NO_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_EVAL_NO_OK_MESSAGE");
		POSTCONDITION_OF_TASK_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_OF_TASK_OK_MESSAGE");
		POSTCONDITION_OF_TASK_NO_OK_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_OF_TASK_NO_OK_MESSAGE");
		POSTCONDITION_ERROR_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_ERROR_MESSAGE");
		NOT_YET_CHECKED_POSTCONDITION_MESSAGE = KMADeMain.messages
				.getString("NOT_YET_CHECKED_POSTCONDITION_MESSAGE");
		POSTCONDITION_CHECKED_AND_BUILT_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_CHECKED_AND_BUILT_MESSAGE");
		POSTCONDITION_PROGRESSBAR_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_PROGRESSBAR_MESSAGE");
		POSTCONDITION_CONCRETE_OBJECT_TITLE_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_CONCRETE_OBJECT_TITLE_MESSAGE");
		POSTCONDITION_HISTORY_TITLE_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_HISTORY_TITLE_MESSAGE");
		POSTCONDITION_LOAD_STATE_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_LOAD_STATE_MESSAGE");
		...
		POSTCONDITION_EDITION_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_EDITION_MESSAGE");
		...
		POSTCONDITION_TEXTUEL_EDITION_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_TEXTUEL_EDITION_MESSAGE");
		...
		POSTCONDITION_EXECUTED_STATE_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_EXECUTED_STATE_MESSAGE");
		POSTCONDITION_NO_EXECUTED_STATE_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_NO_EXECUTED_STATE_MESSAGE");
		...
		POSTCONDITION_USER_EDITION_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_USER_EDITION_MESSAGE");
		...
		POSTCONDITION_CONSTRAINT_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_CONSTRAINT_MESSAGE");
		...
		POSTCONDITION_EXPRESSION_MESSAGE_PROBLEM = KMADeMain.messages
				.getString("POSTCONDITION_EXPRESSION_MESSAGE_PROBLEM");
		...
		POSTCONDITION_LOCATION_MESSAGE = KMADeMain.messages
				.getString("POSTCONDITION_LOCATION_MESSAGE");
