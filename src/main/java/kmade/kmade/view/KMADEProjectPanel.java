...
import kmade.kmade.view.taskmodel.KMADETaskDescriptionPanel;
...
import kmade.kmade.view.worldobject.label.KMADELabelPanel;
import kmade.kmade.view.worldobject.user.KMADEReadWriteIndividuObjectPanel;
import kmade.kmade.view.worldobject.user.KMADEReadWriteOrganisationObjectPanel;
import kmade.kmade.view.worldobject.usersystem.KMADEReadWriteMachineObjectPanel;
import kmade.kmade.view.worldobject.usersystem.KMADEReadWriteParcMachinesPanel;
...
public class KMADEProjectPanel extends JPanel implements LanguageFactory {
    ...
    public KMADEProjectPanel() {
    	super();
    	boolean top = true; // permet de mettre les onglets a gauche ou en haut (le haut n'est pas fini d'impl�ment�
        ...
        tabpaneProjet.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                if (tabpaneProjet.getSelectedIndex() == 0) {
                	...
                	// permet la mise � jour des onglets utilisateurs et equipements pour que les mises � jour effectuer dans l'un le soit dans l'autre
