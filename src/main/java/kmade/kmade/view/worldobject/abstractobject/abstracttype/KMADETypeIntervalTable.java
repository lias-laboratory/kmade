package kmade.kmade.view.worldobject.abstractobject.abstracttype;
...
public class KMADETypeIntervalTable extends JScrollPane implements LanguageFactory {
    ...
    public KMADETypeIntervalTable() {
        String[] columnNames = {KMADEConstant.INTERVALLE_NAME_TABLE, KMADEConstant.INTERVALLE_DESCRIPTION_TABLE, KMADEConstant.INTERVALLE_MIN_VALUE_TABLE, KMADEConstant.INTERVALLE_MAX_VALUE_TABLE};
        myTableListModel = new MyTableListModel(columnNames,KMADEConstant.INTERVALLE_NEW_OBJECT_TABLE);
        ...
        this.setBorder(new TitledBorder(null, KMADEConstant.INTERVALLE_TITLE_TABLE, TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION));
    }
    ...
    public void addInterval(String name, String description, Integer min, Integer max, String oid) {
    ...
    class MyTableListModel extends DefaultListTableModel {
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {                 
            if (rowIndex + 1 == this.getRowCount()) {
                ...
                Object[] tempo = {value, "", Intervalle.MIN_DEFAULT, Intervalle.MAX_DEFAULT, newInterval, false};                
                myTableListModel.getListTableData().add(tempo);
                ...
                switch (columnIndex) {
                    case 0 : {
                        if (((String)value).equals("") || ((String)value).equals(nameRow))
                            return;
                        value = IntervalAdaptator.setIntervalName(oidRow, (String)value); 
                        break;
                    }
                    case 1 : IntervalAdaptator.setIntervalDescription(oidRow, (String)value); break;
                    case 2 : {
                        ...
                        IntervalAdaptator.setIntervalMin(oidRow, (Integer)value); break; 
                    }
                    case 3 : {
                        Integer maValue = (Integer)value;
                        ...
                        IntervalAdaptator.setIntervalMax(oidRow, (Integer)value); break;                        
                    }
                }
    ...
    class MyKeyListener extends KeyAdapter {
        public void keyPressed(KeyEvent ke) {
            if (ke.getKeyCode() == KeyEvent.VK_DELETE) {
                ...
                boolean state = GraphicEditorAdaptator.removeSelectedItem("Interval",r,myTableListModel.getListTableData(), GraphicEditorAdaptator.getMainFrame(), KMADEConstant.INTERVALLE_REMOVE_MESSAGE_TITLE);
    ...
    public void notifLocalisationModification() {
        ...
        myTableListModel.setNameDefault(KMADEConstant.INTERVALLE_NEW_OBJECT_TABLE);
    }
}
