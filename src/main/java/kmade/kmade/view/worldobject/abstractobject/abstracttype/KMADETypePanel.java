...
public class KMADETypePanel extends JPanel implements LanguageFactory {
    ...
    public void setBorderTypePanel(String afficher) {
        panel.setBorder(new TitledBorder(null, KMADEConstant.ENUMERATION_TITLE_TABLE + afficher, TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION));
    }
    ...
    public void showEnumOrIntervalPanel(boolean b) {
        ...
        if (!b) {
            panel.setBorder(new TitledBorder(null, KMADEConstant.ENUMERATION_TITLE_TABLE, TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION));
        } else {
