...
import kmade.kmade.view.KMADEProjectPanel;
...
public class KMADETaskModelToolBar extends JPanel {
    ...
    public static final ImageIcon ABSTRACT_TASK_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.ABSTRACT_TASK_16_IMAGE));
    
    public static final ImageIcon INTERACTION_TASK_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.INTERACTIF_TASK_16_IMAGE));
    
    public static final ImageIcon FEEDBACK_TASK_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.FEEDBACK_TASK_16_IMAGE));
    
    public static final ImageIcon USER_TASK_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.USER_TASK_16_IMAGE));
    
    public static final ImageIcon UNKNOWN_TASK_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.UNKNOWN_TASK_16_IMAGE));
    
    public static final ImageIcon ZOOMIN_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.ZOOM_IN_IMAGE));
    
    public static final ImageIcon ZOOMOUT_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.ZOOM_OUT_IMAGE));
    
    public static final ImageIcon ZOOM_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.ZOOM_IMAGE));
       
    public static final ImageIcon ZOOM_GLOBAL_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.ZOOM_GLOBAL_IMAGE));
    
    public static final ImageIcon MAGN_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.MAGNETISM_IMAGE));
    
    public static final ImageIcon JUSTIFY_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.JUSTIFY_IMAGE));
    
    public static final ImageIcon UNIFORM_IMAGE_ICON = new ImageIcon(KMADETaskModelToolBar.class.getResource(KMADEConstant.UNIFORM_IMAGE));
	...
	public KMADETaskModelToolBar() {
        ...
        AbstractAction myShowOrNotTaskLabelToggleAction = new AbstractAction("",KMADETaskModelToolBar.VISIBLE_LABEL_IMAGE_ICON) {
        ...
        AbstractAction myShowOrNotTaskColorLabelToggleAction = new AbstractAction("",KMADETaskModelToolBar.COLOR_LABEL_IMAGE_ICON) {
