...
import kmade.kmade.view.taskmodel.KMADETaskModelPanel.MyBasicGraphUI;
	...
	class MyCellHandle implements CellHandle {
		...
		public void mouseDragged(MouseEvent event) {
			...
			if (cellRef != null) {
				...
				if (haut) {
					// on dessine le trait sur le haut de la cellule de r�f�rence
...
//					 on dessine le trait sur le bas de la cellule de r�f�rence
		...
		public void mouseClicked(MouseEvent event) {
			...
			// on regarde si on a double cliqu� dans un des rectangles d�finis et on fait l'action en cons�quence
