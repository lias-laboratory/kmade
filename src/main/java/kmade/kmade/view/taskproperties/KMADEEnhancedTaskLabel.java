...
public class KMADEEnhancedTaskLabel extends JComponent {
    ...
    private static final Image up = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.UP_TASK_IMAGE)).getImage();

    private static final Image down = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.DOWN_TASK_IMAGE)).getImage();
    
    private static final Image left = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.LEFT_TASK_IMAGE)).getImage();
    
    private static final Image right = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.RIGHT_TASK_IMAGE)).getImage();
    
    private static final Image no_up = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.NO_UP_TASK_IMAGE)).getImage();

    private static final Image no_down = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.NO_DOWN_TASK_IMAGE)).getImage();
    
    private static final Image no_left = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.NO_LEFT_TASK_IMAGE)).getImage();
    
    private static final Image no_right = new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.NO_RIGHT_TASK_IMAGE)).getImage();
