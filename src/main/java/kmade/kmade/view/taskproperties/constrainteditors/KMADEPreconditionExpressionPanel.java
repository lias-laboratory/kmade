...
public class KMADEPreconditionExpressionPanel extends JPanel implements LanguageFactory {
    ...
    public KMADEPreconditionExpressionPanel() {
        ...
        this.isEmpty.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                PreconditionAdaptator
                        .setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EMPTY]
                                .substring(
                                        1,
        ...
        this.isExist.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                PreconditionAdaptator
                        .setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXIST]
                                .substring(
                                        1,
        ...
        this.isExistAt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	PreconditionAdaptator
                .setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXISTAT]
                        .substring(
                                1,
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, literalPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
