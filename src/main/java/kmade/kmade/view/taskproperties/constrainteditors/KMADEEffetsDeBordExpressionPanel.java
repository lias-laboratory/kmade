...
public class KMADEEffetsDeBordExpressionPanel extends JPanel implements LanguageFactory {
    ...
    public KMADEEffetsDeBordExpressionPanel() {
        ...
        this.minusAssignment.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.MINUS_ASSIGNMENT]
                                .substring(1, EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.MINUS_ASSIGNMENT].length() - 1));
            }
        });
        this.plusAssignment.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.PLUS_ASSIGNMENT]
                                .substring(1, EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.PLUS_ASSIGNMENT].length() - 1));
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator
                        .setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_BOOLEAN]
                                .substring(1, EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_BOOLEAN].length() - 1));
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator
                        .setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_NUMBER]
                                .substring(1, EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_NUMBER].length() - 1));
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator
                        .setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_STRING]
                                .substring(1, EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_STRING].length() - 1));
            }
        });
        this.vcst1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String currentValue = ((String) vcstchoice1.getSelectedItem());
                EffetsDeBordAdaptator.addNewLiteral(TypeStructure.getLocaleTypeStructureIntoEnumere(currentValue), vcst1.getText());
            }
        });
        ...
        this.getValue2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EffetsDeBordAdaptator
                        .setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.GETVALUE]
                                .substring(
                                        1,
