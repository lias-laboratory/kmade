...
public class CustomOptionDialog extends JDialog {
    ...
    public static int showAllConfirmDeleteDialog(Window owner, String titre, String message) {
        ...
        myDialog.getRootPane().setWindowDecorationStyle(JRootPane.QUESTION_DIALOG);
        ...
        JLabel myLabelImage = new JLabel(new ImageIcon(CustomOptionDialog.class.getResource(KMADEConstant.ASK_DIALOG_IMAGE)));
