...
import kmade.kmade.UI.toolutilities.JListTreeTable;
import kmade.kmade.UI.toolutilities.LanguageFactory;
import kmade.kmade.UI.toolutilities.JTreeTable.DefaultTreeTableModel;
        ...
        public void setValueAt(Object aValue, Object node, int column) {
            ...
            if (column == 1) {
            	...
            	if (refNode.getEntity() instanceof ConcreteObjectNewLineUserObject) {
            		// Ajouter
                  ObjetConcret newConcreteObject = ConcreteObjectAdaptator.addNewConcreteObject((Groupe)((ConcreteObjectNode)refNode.getParent()).getEntity(),(String)aValue);
                  ...
                  listTreeTable.getTreeTable().getSelectionModel().setSelectionInterval(t,t);
            		...
            		// Modifier
            			...
            			if (!(temp.getName()).equals((String)aValue)) {
            				ConcreteObjectAdaptator.setConcreteObjectName((ObjetConcret)(refNode.getEntity()),(String)aValue);
            				this.nodeStructureChanged(refNode.getParent());
