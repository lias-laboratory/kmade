...
public class KMADEReadMachineInParc extends JScrollPane implements LanguageFactory {
			...
			public void keyTyped(KeyEvent ke) { 
				...
				if (ke.getKeyChar() == KeyEvent.VK_DELETE || ke.getKeyChar() == KeyEvent.VK_ENTER) {
					...
					for(int i =0;i<r.length;i++){
						...
						KMADEMainFrame.getProjectPanel().getParcMachinesPanel().removeMachineOfParc(oidMachine);
					}
	...
	public void setMachineMemberNameBorder(String name) {
		this.setBorder(new TitledBorder(null, KMADEConstant.PARCMACHINES_MACHINE_TABLE + " : " + name,
