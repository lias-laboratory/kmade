...
public class KMADEReadWriteAbstractAttributesTable extends JScrollPane implements LanguageFactory {
	...
	private static int typeOfStructure = 0; // 0 : aucune, 1 : enumÃ©ration, 2 : intervalle.
	...
	public KMADEReadWriteAbstractAttributesTable() {
		...
		// SpecialString puisque l'on a un popup et une vérification de nom
	...
	class MyTableListModel extends DefaultListTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			if (rowIndex == this.getRowCount() - 1) {
				// La ligne pour crÃ©er de nouvelles lignes.
				if (columnIndex == 0) {
				...
				if (columnIndex == 3) {
					...
					if (chaineType.equals(TypeStructure.INTERVAL_STRUCT.getValue())) {
                        ...
                        // Tous sauf Enumï¿½ration et Intervalle.
						return "";
					}
				}
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
			...
			if (rowIndex + 1 == this.getRowCount()) {
				...
				Object[] tempo = {name, "", TypeStructure.STRING_STRUCT.getValue(), nomType, newAbstractObject, false};
