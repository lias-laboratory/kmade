...
public class KMADEReadIndividuNotInOrganisation extends JScrollPane implements LanguageFactory {
	...
	public KMADEReadIndividuNotInOrganisation(){
		modele = new myModel();
			...
			public void keyTyped(KeyEvent ke) { 
				...
				if (ke.getKeyChar() == KeyEvent.VK_DELETE || ke.getKeyChar() == KeyEvent.VK_ENTER) {
					...
					for(int i =0;i<r.length;i++){
						...
						KMADEMainFrame.getProjectPanel().getOrganisationPanel().addIndividuInOrganization(oidIndi);
					}
	...
	static class myModel extends AbstractTableModel {
		...
		public String getColumnName(int i) {
			switch (i) {
			case 0 : return KMADEConstant.INDIVIDU_NAME_TABLE;
			case 1 : return KMADEConstant.INDIVIDU_STATUS_TABLE;
			case 2 : return KMADEConstant.INDIVIDU_ROLE_TABLE;
			case 3 : return KMADEConstant.INDIVIDU_PHOTO_TABLE;
			case 4 : return KMADEConstant.INDIVIDU_ORGANIZATION_TABLE;
			default : return "";
			}
		}
	...
	public void setIndividuNotInOrganisationNameBorder(String name) {
		this.setBorder(new TitledBorder(null, KMADEConstant.ORGANIZATION_OTHERS+ " " + KMADEConstant.ORGANIZATION_MEMBERS_TABLE + " : " + name,
