...
/**
 * Cette classe contient les fonctions qui permettent de vérifier si un nom est correct
 * 
 * Il est important de reporter les modifications apportées à cette classe pouvant impacter la calculette dans les classes de la calculette. 
 * @author Thomas Lachaume
 *
 */
public class RegularExpression {
	
	public static String avecEspace = "[[a-zA-Z]*[0-9]*[é]*[ ]*[è]*[-]*[_]*[ç]*[à]*[@]*[*]*[µ]*[£]*[§]*[%]*[~]*[#]*[{]*[}]*[|]*[`]*[²]*]";
	// définition des caractères avec le caractère espace
	public static String sansEspace = "[[a-zA-Z]*[0-9]*[é]*[è]*[-]*[_]*[ç]*[à]*[@]*[*]*[µ]*[£]*[§]*[%]*[~]*[#]*[{]*[}]*[|]*[`]*[²]*]";
	...
	// construction de groupeExpression ( ajout d'un nom avec un seul caractère)
