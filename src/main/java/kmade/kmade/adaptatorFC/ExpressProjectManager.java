...
import kmade.nmda.schema.project.GeneralInformation;
import kmade.nmda.schema.project.InterviewIndex;
import kmade.nmda.schema.project.Project;
...
public class ExpressProjectManager {
    ...
    public static void removeAllGeneralInformationAndInterviewIndexEntity(Oid oidProject) {
        // Suppression du projet
        Project myProject = (Project)InterfaceExpressJava.prendre(oidProject);
        GeneralInformation myGeneralInformation = myProject.getGeneralInformation();
        InterfaceExpressJava.remove(myGeneralInformation.getOid());
        
        ArrayList<InterviewIndex> myInterviewIndex = myProject.getInterviewIndex();
    ...
    public static String getProjectManager() {
        Object[] temp = InterfaceExpressJava.prendreAllOidOfEntity("project", "Project");
    ...
    public static String createInterviewIndex(Oid oidProject) {
        Oid oidInterviewIndex = InterfaceExpressJava.createEntity("project", "InterviewIndex");
        InterviewIndex objInterviewIndex = (InterviewIndex)InterfaceExpressJava.prendre(oidInterviewIndex);
    ...
    public static String createInterviewIndex(Oid oidProject, String interviewed, String placeInformation, String statut,
            String seniority, String date,  String interviewType, String searchedInformations, String interviewerName) {
        Oid oidInterviewIndex = InterfaceExpressJava.createEntity("project", "InterviewIndex");
        InterviewIndex objInterviewIndex = (InterviewIndex)InterfaceExpressJava.prendre(oidInterviewIndex);
    ...
    public static String createGeneralInformation(Oid oidProject,String entreprise,String site,String typePost,String date,String resources, String justification) {
        Oid oidGeneralInformation = InterfaceExpressJava.createEntity("project", "GeneralInformation");
        GeneralInformation objGeneralInformation = (GeneralInformation)InterfaceExpressJava.prendre(oidGeneralInformation);
    ...
    public static String[] getAllGeneralInformation(Oid oidProject) {
        Project myProject = (Project)InterfaceExpressJava.prendre(oidProject);
        GeneralInformation generalInformation = myProject.getGeneralInformation();
    ...
    public static ArrayList<Object[]> getAllInterviewIndex(Oid oidProject) {
        Project myProject = (Project)InterfaceExpressJava.prendre(oidProject);
        ArrayList<InterviewIndex> interviewIndex = myProject.getInterviewIndex();
    ...
    public static void setInterviewedName(String oid, String interviewedName) {
        InterviewIndex m = (InterviewIndex) InterfaceExpressJava.prendre(new Oid(oid));
    ...
    public static void setSearchedInformations(String oid, String searchedInformations) {
        InterviewIndex m = (InterviewIndex) InterfaceExpressJava.prendre(new Oid(oid));
