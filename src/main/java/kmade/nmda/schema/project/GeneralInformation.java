...
public class GeneralInformation implements Entity {
    ...
    public GeneralInformation(String pentreprise, String psite, String ptypePost, String pdate, String presources, String justification, Oid o) {
    ...
    public String toSPF() {
        String spfString = oid.get() + "=" + "GeneralInformation" + "(" + "'" + entreprise + "'" + ","
        + "'" + site + "'" + "," + "'" + typePost + "'" + "," + "'" + date + "'" + ","
