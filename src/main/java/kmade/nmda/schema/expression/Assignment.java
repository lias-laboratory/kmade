...
public class Assignment extends AssignmentOperator {
	...
	public void checkNode() throws SemanticException {
		...
		// L'ensemble des if commentÈs correspond ‡† des cast que l'on ne souhaite plus
		/*
       ...
       if (getLeftNode().isBoolean() && getRightNode().isString()) {
        ...
        if (getLeftNode().isBoolean() && getRightNode().isNumber()) {                          
            ...
            this.setStateToUnknown();
            return;
        //Si on a un nombre et une cha√Æne de caract√®res, on essaye de construire un NumberValue avec la cha√Æne
	...
	public void evaluateNode(ObjetConcret ref) throws SemanticException {
		...
		// dans certains cas un java null pointer exception peut Ítre lever ce qui correspond ‡ une semanticunknownException
		try{
