...
public class SetFunction extends BinaryFunction implements ConcreteObjectType {
    ...
    public void checkNode() throws SemanticException {
        super.checkNode();
        InterfaceExpressJava.getCurrentObject().setCurrentCheckGroup(((AttributExpressExpression)((AssignmentOperator)this.rightNode).getLeftNode()).getGroupExpressExpression().getGroup());
    }
