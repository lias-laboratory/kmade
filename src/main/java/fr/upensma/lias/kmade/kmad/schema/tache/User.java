...
public abstract class User implements Entity {
	 ...
	 * correctness of the link CommentPG: I am not sure of the interest of this
	 * inverse link. It seems not used at all, and there is no way to use the list
	 * of actors related to a user...
	 * 
	...
	/**
	 * Utilitary static function able to verify in the whole express model that a
	 * name is unique among all existing users (User, Individu, Organisation
	...
	/**
	 * Static method to calculate a new name composed by a supposed not unique name
	 * and a numerical value. For example, if the name Patrick already exists, it
	 * will search for Patrick_1, and Patrick_2 if needed, and so on.
	 * 
	...
	public String toSPF() {
		return oid.get() + "=User('" + name + "','" + status + "','" + role + "','" + this.imagePath + "');";
	}
