...
public class AttributAbstrait implements Entity {
    ...
    public AttributAbstrait(String name, String description, String type,
	    ObjetAbstrait classe, TypeAbs typeref, Oid oid) {
	this.name = name;
    ...
    public AttributAbstrait(String name, ObjetAbstrait classe, TypeAbs type,
	    String type2) {
	this.name = name;
	this.description = "";
	this.setUtiliseeparClass(classe);
