...
public class ObjetConcret implements Entity, Cloneable {
	...
	public String toSPF() {
		String SPF = oid.get() + "=" + "ObjetConcret" + "(" + "'" + name + "'" + "," + "'" + description + "'" + ",";
	...
	public void createObjectFromXMLElement2(Element p) throws Exception {
		...
		this.setAppartientGroupe(
				(Groupe) InterfaceExpressJava.bdd.prendre(new Oid(p.getAttribute("id-concreteobject-group"))));
		NodeList nodeList = p.getElementsByTagName("concreteobject-name");
		if (nodeList != null && nodeList.item(0) != null && nodeList.item(0).getParentNode() != p) {
			nodeList = null;
		}
