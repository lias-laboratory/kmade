...
public class ObjetConcret implements Entity, Cloneable {
    ...
    public ObjetConcret(String name, String description, ObjetAbstrait objAbs, Oid oid) {
        this.name = name;
    ...
    public ObjetConcret(String name, String description, Groupe g, ObjetAbstrait objAbs, Oid oid) {
        this.name = name;
        this.description = description;
        this.setUtiliseParClass(objAbs);
        this.oid = oid;
    ...
    public void createObjectFromXMLElement(org.w3c.dom.Element p) {
        ...
        this.setUtiliseParClass((ObjetAbstrait)InterfaceExpressJava.bdd.prendre(new Oid(nodeList.item(0).getTextContent())));
        
        nodeList = p.getElementsByTagName("id-concreteobject-group");
        this.setAppartientGroupe((Groupe)InterfaceExpressJava.bdd.prendre(new Oid(nodeList.item(0).getTextContent())));
    }
    ...
    public static boolean isUniqueName(String s) {
        Object[] objAbs = InterfaceExpressJava.prendreAllOidOfEntity("metaobjet", "ObjetConcret");
    ...
    public Object clone() {
    	...
    	for (int i = 0 ; i < inverseAttribut.size(); i++) {
    		AttributConcret temp = (AttributConcret)(inverseAttribut.get(i)).clone();
