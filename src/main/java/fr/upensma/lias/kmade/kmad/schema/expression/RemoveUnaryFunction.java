 ...
 */
public class RemoveUnaryFunction extends UnaryFunction implements
	ConcreteObjectType {
	...
	return (((GroupExpressExpression) this.myAloneExpression).getGroup()
	...
	refUserObjetConcret.getAppartientGroupe().removeFromGroup(
		refUserObjetConcret);
	refUserObjetConcret.getUtiliseParClass().removeInverseObjConc(
		refUserObjetConcret);
