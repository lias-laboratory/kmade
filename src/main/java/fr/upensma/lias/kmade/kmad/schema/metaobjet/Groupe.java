...
public class Groupe implements Entity {
	...
	public Groupe(String nom, String d, Agregat ag, ObjetAbstrait typeObj, Oid oid) {
		name = nom;
		description = d;
	...
	public void affDelete() {
		InterfaceExpressJava.getGestionWarning().addMessage(oid, 2,
				ExpressConstant.REMOVE_OF_THE_ABSTRACT_OBJECT_MESSAGE + " \"" + contientObj.getName() + "\"");
	...
	public void createObjectFromXMLElement(org.w3c.dom.Element p) {
		...
		this.setEnsemble((Agregat) InterfaceExpressJava.bdd.prendre(new Oid(nodeList.item(0).getTextContent())));
	...
	public String toSPF() {
		String SPF = oid.get() + "=" + "Groupe" + "(" + "'" + name + "'" + "," + "'" + description + "'" + ",";
	...
	public void createObjectFromXMLElement2(Element p) throws Exception {
		this.oid = new Oid(p.getAttribute("idkmad"));
		this.setEnsemble((Agregat) InterfaceExpressJava.bdd.prendre(new Oid(p.getAttribute("id-group-agregat"))));

		this.setContientObj(
				(ObjetAbstrait) InterfaceExpressJava.bdd.prendre(new Oid(p.getAttribute("id-group-abstractobject"))));
