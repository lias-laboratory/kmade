...
public class Groupe implements Entity {
    ...
    public void affDelete() {
        InterfaceExpressJava.getGestionWarning().addMessage(oid, 2, ExpressConstant.REMOVE_OF_THE_ABSTRACT_OBJECT_MESSAGE + " \"" + contientObj.getName() + "\"");
    ...
    public void createObjectFromXMLElement(org.w3c.dom.Element p) {
        ...
        this.setContientObj((ObjetAbstrait)InterfaceExpressJava.bdd.prendre(new Oid(nodeList.item(0).getTextContent())));
    }
    ...
    public static boolean isUniqueName(String s) {
        Object[] objAbs = InterfaceExpressJava.prendreAllOidOfEntity("metaobjet", "Groupe");
