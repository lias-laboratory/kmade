...
public class ActorSystem implements Entity {
	...
	public void affDelete() {
		InterfaceExpressJava.getGestionWarning().addMessage(oid, 15,
	...
	public void createObjectFromXMLElement(org.w3c.dom.Element p) {
		...
		this.materialRef = (Material) InterfaceExpressJava.bdd.prendre(new Oid(nodeList.item(0).getTextContent()));
	}

	public String toSPF() {
		String SPF = oid.get() + "=" + "Acteur System" + "(" + experience.toSPF() + "," + "'" + competence + "'" + ",";
		if (materialRef != null)
	...
	public void createObjectFromXMLElement2(Element p) throws Exception {
		this.oid = new Oid(p.getAttribute("idkmad"));
		this.materialRef = (Material) InterfaceExpressJava.bdd.prendre(new Oid(p.getAttribute("id-user")));
		this.experience = Experience.getXMLExperienceValue(p);
