...
public enum Executor implements Enumerated {
	INCONNU("UNK", ExpressConstant.UNKNOWN_TASK_16_IMAGE), USER("USER", ExpressConstant.USER_TASK_16_IMAGE),
	SYS("SYS", ExpressConstant.FEEDBACK_TASK_16_IMAGE), INT("INT", ExpressConstant.INTERACTIF_TASK_16_IMAGE),
	...
	public static Executor getLocaleExecutorIntoExecutor(String myStringExecutor) {
		if (myStringExecutor.equals(ExpressConstant.UNKNOWN_EXECUTANT_NAME))
			...
			return Executor.SYS;
		else if (myStringExecutor.equals(ExpressConstant.INTERACTION_EXECUTANT_NAME))
			return Executor.INT;
		else if (myStringExecutor.equals(ExpressConstant.ABSTRACT_EXECUTANT_NAME))
			return Executor.ABS;
		else
			return Executor.INCONNU;
	}
