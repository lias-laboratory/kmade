...
public class KMADeMain { 
	...
	public static void main(String[] args) throws Exception {
		...
		if (!KMADeMain.loadKMADEResourceBundle(new Locale(temp))) {
			...
			KMADEHistoryMessageManager.printlnMessage("Failure for loading the " + temp
					+ " localization.");
	...
	public static boolean loadKMADEResourceBundle(Locale myLocale) {
		try {
			KMADeMain.messages = ResourceBundle.getBundle(KMADEToolConstant.BUNDLE_FILE, myLocale, new ExtendedControl());
