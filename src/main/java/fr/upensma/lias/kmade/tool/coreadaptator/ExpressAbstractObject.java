...
public class ExpressAbstractObject {
    ...
    /**
     * Cette méthode permet de retourner l'ensemble des valeurs utilisées pour
     * la Table qui crée les attributs.
     * 
     * @param oidObj
    ...
    /**
     * Cette méthode récupère l'ensemble des objets concret d'un objet abstrait
     * donné.
     * 
     * @param oidObj
     * @return
