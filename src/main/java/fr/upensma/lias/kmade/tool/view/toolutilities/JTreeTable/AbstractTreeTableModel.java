...
public abstract class AbstractTreeTableModel implements TreeTableModel {
	/**
	 * Value returned by
	 * {@link org.jdesktop.swing.treetable.TreeTableModel#getColumnClass(int)
	 * getColumnClass} for the
	 * {@link org.jdesktop.swing.JXTreeTable#isHierarchical(int) hierarchical}
	 * column.
	 */
	...
	/**
	 * Constructs an <code>AbstractTreeTableModel</code> with the specified node as
	 * the root node.
	 *
	 ...
	 * child array. <I>parent</I> must be a node previously obtained from this data
	 ...
	 * @return the index of the child in the parent, or -1 if either the parent or
	 *         the child is <code>null</code>
	 */
	 ...
	 * <code>DefaultTreeModel</code> <code>m</code> for its tree model listeners
	 ...
	 * getColumnName(int column) public Object getValueAt(Object node, int column)
