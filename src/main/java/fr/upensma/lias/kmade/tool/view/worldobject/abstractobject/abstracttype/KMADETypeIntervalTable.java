...
public class KMADETypeIntervalTable extends JScrollPane implements LanguageFactory {
	...
	public KMADETypeIntervalTable() {
		String[] columnNames = { KMADEConstant.INTERVALLE_NAME_TABLE, KMADEConstant.INTERVALLE_DESCRIPTION_TABLE,
				KMADEConstant.INTERVALLE_MIN_VALUE_TABLE, KMADEConstant.INTERVALLE_MAX_VALUE_TABLE };
		...
		this.setBorder(new TitledBorder(null, KMADEConstant.INTERVALLE_TITLE_TABLE, TitledBorder.CENTER,
	...
	class MyTableListModel extends DefaultListTableModel {
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
			if (rowIndex + 1 == this.getRowCount()) {
				...
				case 1:
					IntervalAdaptator.setIntervalDescription(oidRow, (String) value);
					break;
				case 2: {
	...
	class MyKeyListener extends KeyAdapter {
		public void keyPressed(KeyEvent ke) {
			if (ke.getKeyCode() == KeyEvent.VK_DELETE) {
				...
				boolean state = GraphicEditorAdaptator.removeSelectedItem("Interval", r,
