...
public class JListTable extends JPanel {
	...
	if (type.equals("String")) {
	    myTable.getColumnModel()
		    .getColumn(column)
		    .setCellEditor(
			    new MyCustomStringTableCellEditor(column, myTable));
	    return;
	}

	if (type.equals("List")) {
	    myTable.getColumnModel().getColumn(column)
		    .setCellEditor(new MyCustomListTableCellEditor(value));
	    return;
	}
	if (type.equals("SpecialString")) {
	    myTable.getColumnModel()
		    .getColumn(column)
		    .setCellEditor(
			    new MyCustomSpecialStringTableCellEditor(column,
				    myTable));
	}
    }
    ...
    class MyCustomSpecialStringTableCellEditor extends AbstractCellEditor
	...
	public MyCustomSpecialStringTableCellEditor(int newColumn, JTable t) {
		...
		public void focusLost(FocusEvent e) {
		    ...
		    // l'initialisation )
		    try {
			if (e.getOppositeComponent().getClass().getSimpleName()
				.equals("MultiplexingTextField")) {
