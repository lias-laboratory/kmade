...
public final class ConcreteObjectAdaptator {
	...
	public static String addConcreteObject(String pGroupName) {
		...
		String newOidConcreteObject = ExpressConcreteObject.createConcreteObject(
				new Oid(ConcreteObjectPanelAdaptator.getActiveAbstractObject()),
	...
	public static ObjetConcret addNewConcreteObject(Groupe myGroup, String concreteObjectName) {
		...
		ObjetConcret refConcreteObject = ExpressConcreteObject.createConcreteObject(
				new Oid(ConcreteObjectPanelAdaptator.getActiveAbstractObject()), myGroup, concreteObjectName);
