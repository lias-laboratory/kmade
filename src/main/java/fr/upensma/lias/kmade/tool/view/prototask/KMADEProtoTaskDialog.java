...
public class KMADEProtoTaskDialog extends JFrame {
	...
	public void setIterationEnabled(Task t, boolean existed, ChoiceEnum enabled) {
		...
		if (existed) {
			groupButton = new trueFalseIndeterminateGroupButton(t.getIterExpression().getDescription(),
					t.getIterExpression().getDescription(), enabled, true, false);
	...
	class trueFalseIndeterminateGroupButton extends JPanel implements ActionListener {
		...
		public trueFalseIndeterminateGroupButton(String conditionDisplay, String condition, ChoiceEnum choice,
				boolean enabled, boolean shift) {
