...
public class Excution{
	...
	private static void iCanBeActivable(Task t) {
		...
		if(t.getPreExpression().getProtoTaskConditionExpression()!=null && !t.getPreExpression().getProtoTaskConditionExpression().getValue().getDescription().equals("")){
			if(t.getPreExpression().getProtoTaskConditionExpression().getValue().getCurrentValue() == StateCondition.TRUE){
	...
	private static void waitEndTask(Task t) {
		...
		if(t.getIterExpression().getProtoTaskConditionExpression()!=null && !t.getIterExpression().getProtoTaskConditionExpression().getValue().getDescription().equals("")){
			if(t.getIterExpression().getProtoTaskConditionExpression().getValue().getCurrentValue() == StateCondition.TRUE){
