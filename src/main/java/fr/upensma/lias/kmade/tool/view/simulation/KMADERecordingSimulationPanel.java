...
public class KMADERecordingSimulationPanel extends JPanel {
	...
	public static final ImageIcon PLAYER_ACTION_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_ACTION_IMAGE));
	...
	public KMADERecordingSimulationPanel() {
		...
		this.myListActivableBorder = new TitledBorder(null, KMADEConstant.RECORD_AVAILABLE_ACTIONABLE_MESSAGE,
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (e.getClickCount() == 2) {
					if (availableTaskList.getSelectedValue() != null) {
						SimulationAdaptator
								.launchActionFromRecord((TokenSimulation) availableTaskList.getSelectedValue());
					}
				}
			}
		});
		...
		this.myScrollListScenarioBorder = new TitledBorder(null, KMADEConstant.RECORD_BUILDING_SCENARION_MESSAGE,
				TitledBorder.CENTER, TitledBorder.TOP);
