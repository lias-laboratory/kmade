...
public class TokenRecordScenarioSimulation extends TokenSimulation {
    ...
    /**
     * @param myConcreteIter
     *            The myConcreteIter to set.
     */
    ...
    /**
     * @param myConcretePost
     *            The myConcretePost to set.
     */
    ...
    /**
     * @param myUserValueIter
     *            The myUserValueIter to set.
     */
    ...
    /**
     * @param myUserValuePost
     *            The myUserValuePost to set.
     */
    ...
    /**
     * @param myUserValuePre
     *            The myUserValuePre to set.
     */
