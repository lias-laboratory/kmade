...
/** Pie Menu pour la cr�ation des t�ches */
			...
			public State menuOff = new State() {
				...
				Transition pressToDisplay = new Press(BUTTON3, ">> menuOn") {
					...
					public void action() {
						...
						// on r�cup�re l'information concernant la position de la souris � l'�cran pour calculer le d�calage via l'information r�� via get point
