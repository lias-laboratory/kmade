...
public class ExpressProjectManager {
	...
	public static String createInterviewIndex(Oid oidProject, String interviewed, String placeInformation,
			String statut, String seniority, String date, String interviewType, String searchedInformations,
	...
	public static String createGeneralInformation(Oid oidProject, String entreprise, String site, String typePost,
			String date, String resources, String justification) {
		Oid oidGeneralInformation = InterfaceExpressJava.createEntity(ExpressConstant.PROJECT_PACKAGE,
