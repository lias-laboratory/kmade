	...
	public KMADEFindReplaceDialog(Frame owner) {
		...
		find.getNameFind().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SearchAdaptator.find(find.getFindName(), find.getExecutantValue(), find.getDecompositionValue(),
						find.getInterruptibleIndex(), find.getOptionalIndex(), regularExpressions.isSelected(),
						caseSensitiveButton.isSelected(), wholeWordButton.isSelected(), allButton.isSelected());
			}
		});
		...
		myList.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent e) {
				if (myList.getSelectedValue() instanceof Task) {
					SearchAdaptator.selectTasksFromOccurence(((Task) (myList.getSelectedValue())),
		...
		saveOccurence.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SearchAdaptator.resultatSearch(find.getFindName(), find.getExecutantValue(),
						find.getDecompositionValue(), find.getInterruptibleString(), find.getOptionalString(),
						regularExpressions.isSelected(), caseSensitiveButton.isSelected(), wholeWordButton.isSelected(),
		...
		findReplaceButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SearchAdaptator.replaceAndNext(find.getFindName(), replace.isWholeNameChecked(), replace.getFindName(),
						replace.getExecutantValue(), replace.getDecompositionValue(), replace.getInterruptibleIndex(),
		...
		replaceButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SearchAdaptator.replace(find.getFindName(), replace.isWholeNameChecked(), replace.getFindName(),
						replace.getExecutantValue(), replace.getDecompositionValue(), replace.getInterruptibleIndex(),
						replace.getOptionalIndex());
			}
		});
	...
	static class MyListCellRenderer implements ListCellRenderer {
		public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
			...
			if (value instanceof Task) {
				...
				stringToDisplay = (index + 1) + " : " + myTemp.getNumber() + " - " + myTemp.getName();
