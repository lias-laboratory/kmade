...
public class KMADEProjectPanel extends JPanel implements LanguageFactory {
	...
	public KMADEProjectPanel() {
		...
		if (v2) {
			...
			/* 0 espace de tache */tabpaneProjet.addTab(KMADEConstant.TASK_DESCRIPTION_TABBEDPANE_TITLE_NAME,
					taskDescriptionPanel);
			/* 1 condition */
			tabpaneProjet.addTab(KMADEConstant.CONDITION_TABBEDPANE_TITLE_MESSAGE, tableCondition);

			/* 2 objet abstrait */tabpaneProjet.addTab(KMADEConstant.ABSTRACT_OBJECT_TABBEDPANE_TITLE_NAME, tablesEDM);
			/* 3 objet concret */tabpaneProjet.addTab(KMADEConstant.CONCRETE_TASK_OBJECT_TABBEDPANE_TITLE_NAME,
					concreteObjectPanel);
			/* 4 individus */tabpaneProjet.addTab(KMADEConstant.INDIVIDU_TABBEDPANE_TITLE_NAME, tableIndividu);
			/* 5 organisation */tabpaneProjet.addTab(KMADEConstant.ORGANIZATION_TABBEDPANE_TITLE_NAME,
					tableOrganisation);
			/* 6 machines */tabpaneProjet.addTab(KMADEConstant.MACHINE_TABBEDPANE_TITLE_NAME, tableMachine);
			/* 7 parcs machine */tabpaneProjet.addTab(KMADEConstant.PARCMACHINES_TABBEDPANE_TITLE_NAME,
					tableParcMachines);
			/* 8 event */tabpaneProjet.addTab(KMADEConstant.EVENT_TABBEDPANE_TITLE_NAME, tableEvent);
			/* 9 label */tabpaneProjet.addTab(KMADEConstant.LABEL_TITLE_MESSAGE, refLabelPanel);
			...
			/* 2 objet concret */tabpaneProjet.addTab(KMADEConstant.CONCRETE_TASK_OBJECT_TABBEDPANE_TITLE_NAME,
					concreteObjectPanel);
			/* 3 individus */tabpaneProjet.addTab(KMADEConstant.INDIVIDU_TABBEDPANE_TITLE_NAME, tableIndividu);
			/* 4 organisation */tabpaneProjet.addTab(KMADEConstant.ORGANIZATION_TABBEDPANE_TITLE_NAME,
					tableOrganisation);
			/* 5 machines */tabpaneProjet.addTab(KMADEConstant.MACHINE_TABBEDPANE_TITLE_NAME, tableMachine);
			/* 6 parcs machine */tabpaneProjet.addTab(KMADEConstant.PARCMACHINES_TABBEDPANE_TITLE_NAME,
					tableParcMachines);
	...
	public void notifLocalisationModification() {
		// NMDAProjectPanel
		tabpaneProjet.setIconAt(0,
				new VerticalTextIcon(KMADEConstant.TASK_DESCRIPTION_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(2,
				new VerticalTextIcon(KMADEConstant.ABSTRACT_OBJECT_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(3,
				new VerticalTextIcon(KMADEConstant.CONCRETE_TASK_OBJECT_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(4, new VerticalTextIcon(KMADEConstant.INDIVIDU_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(5, new VerticalTextIcon(KMADEConstant.ORGANIZATION_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(6, new VerticalTextIcon(KMADEConstant.MACHINE_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(7, new VerticalTextIcon(KMADEConstant.PARCMACHINES_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(8, new VerticalTextIcon(KMADEConstant.EVENT_TABBEDPANE_TITLE_NAME, false, this));
		tabpaneProjet.setIconAt(9, new VerticalTextIcon(KMADEConstant.LABEL_TITLE_MESSAGE, false, this));
