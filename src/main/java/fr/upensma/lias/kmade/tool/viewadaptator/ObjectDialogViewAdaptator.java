...
public final class ObjectDialogViewAdaptator {
	...
	public static void openObjectViewDialog() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().setVisible(true);
	}
	...
	public static void closeObjectViewDialog() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().setVisible(false);
	}
	...
	public static void createAbstractObject() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().createAbstractObject();
		updateTaskPropPanel();
	}
	...
	public static void removeAbstractObject() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().removeAbstractObject();
	...
	public static void addAttribute() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().addAttribute();
		updateTaskPropPanel();
	}
	...
	public static void removeAttribute() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().removeAttribute();
		updateTaskPropPanel();
	}
	...
	public static void createNewGroup(String instance) {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().createNewGroup(instance);
	}
	...
	public static void removeObject() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().removeObject();
		checkSaveStatus();
	}
	...
	public static void editObject() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().editObject();
	}
	...
	public static void setAddAttributeEnabled(boolean condition) {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().getToolBar().setAddAttributeEnabled(condition);
	}
	...
	public static void setEditGroupEnabled(boolean condition) {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().getToolBar().setEditGroupEnabled(condition);
	}
	...
	public static void setConcreteObjectEnabled() {
		GraphicEditorAdaptator.getMainFrame().getObjectDialogView().getToolBar().setConcreteObjectEnabled();
		hideAbstractObjectTable();
	}
	...
	public static void updateTaskPropPanel() {
		if (KMADEEditorPrePostIterDialog.getPreconditionPanel().isVisible()
				...
				|| KMADEEditorPrePostIterDialog.getPostonditionPanel().isVisible()) {
