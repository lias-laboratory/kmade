 ...
 */
public class KMADEEffetsDeBordExpressionPanel extends JPanel implements
	LanguageFactory {
	...
	this.add.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.ADD]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.ADD]
					.length() - 1)
			+ "(" + "  " + ")");
	    }
	});
	this.assignment.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.ASSIGNMENT]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.ASSIGNMENT]
						.length() - 1));
	    }
	});
	this.create.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.CREATE]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.CREATE]
					.length() - 1)
			+ "(" + "  ,  " + ")");
	    }
	});
	this.minusAssignment.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.MINUS_ASSIGNMENT]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.MINUS_ASSIGNMENT]
						.length() - 1));
	    }
	});
	this.plusAssignment.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.PLUS_ASSIGNMENT]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.PLUS_ASSIGNMENT]
						.length() - 1));
	    }
	});
	this.remove.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.REMOVE]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.REMOVE]
					.length() - 1)
			+ "(" + "  " + ")");
	    }
	});
	this.replace.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.REPLACE]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.REPLACE]
					.length() - 1)
			+ "(" + "  ,  " + ")");
	    }
	});
	this.set1.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.SET]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.SET]
					.length() - 1)
			+ "(" + "  " + ")");
	    }
	});
	...
	this.ubool1.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_BOOLEAN]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_BOOLEAN]
						.length() - 1));
	    }
	});
	this.uint1.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_NUMBER]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_NUMBER]
						.length() - 1));
	    }
	});
	this.ustr1.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_STRING]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.UNKNOWN_STRING]
						.length() - 1));
	    }
	});
	this.vcst1.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.addNewLiteral(TypeStructure
			.getLocaleTypeStructureIntoEnumere(currentValue), vcst1
			.getText());
	    }
	});
	...
	this.sequence.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		EffetsDeBordAdaptator
			.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.SEQUENCE]
				.substring(
					1,
					EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.SEQUENCE]
						.length() - 1));
	    }
	});
	...
	this.getValue2.addActionListener(new ActionListener() {
		...
		EffetsDeBordAdaptator.setNewToken(EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.GETVALUE]
			.substring(
				1,
				EffetsDeBordConstants.tokenImage[EffetsDeBordConstants.GETVALUE]
					.length() - 1)
			+ "(" + "  ,  " + ")");
	    }
	});
	...
	operatorPanel1.setBorder(javax.swing.BorderFactory
	...
	functionjPanel1.setBorder(javax.swing.BorderFactory
	...
	literalPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(
		null, KMADEConstant.LITTERAUX_TITLE_MESSAGE));
	vcst1.setMinimumSize(new java.awt.Dimension(30, 19));

	vcstchoice1.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
	...
	jPanel2Layout.setVerticalGroup(jPanel2Layout
		...
		.add(vcst1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 25,
			Short.MAX_VALUE)
		.add(vcstchoice1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
			25, Short.MAX_VALUE));
