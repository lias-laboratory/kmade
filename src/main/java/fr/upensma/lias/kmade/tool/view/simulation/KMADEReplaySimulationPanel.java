...
public class KMADEReplaySimulationPanel extends JPanel implements LanguageFactory {
	...
	private static final ImageIcon PLAYER_PLAY_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_PLAY_IMAGE));

	private static final ImageIcon PLAYER_STOP_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_STOP_IMAGE));

	private static final ImageIcon PLAYER_PAUSE_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_PAUSE_IMAGE));

	public static final ImageIcon PLAYER_REW_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_REW_IMAGE));

	public static final ImageIcon PLAYER_FWD_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.PLAYER_FWD_IMAGE));

	public static final ImageIcon SAVEAS_SCENARIO_IMAGE = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.SAVEAS_SCENARIO_IMAGE));

	private static final ImageIcon ONE_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.ONE_STEP_IMAGE));

	private static final ImageIcon TWO_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.TWO_STEP_IMAGE));

	private static final ImageIcon THREE_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.THREE_STEP_IMAGE));

	private static final ImageIcon FOUR_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.FOUR_STEP_IMAGE));

	private static final ImageIcon FIVE_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.FIVE_STEP_IMAGE));

	private static final ImageIcon SIX_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.SIX_STEP_IMAGE));

	private static final ImageIcon SEVEN_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.SEVEN_STEP_IMAGE));

	private static final ImageIcon HEIGH_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.HEIGH_STEP_IMAGE));

	private static final ImageIcon NINE_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.NINE_STEP_IMAGE));

	private static final ImageIcon TEN_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.TEN_STEP_IMAGE));

	private static final ImageIcon ELEVEN_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.ELEVEN_STEP_IMAGE));

	private static final ImageIcon TWELVE_TIME = new ImageIcon(
			KMADETaskModelToolBar.class.getResource(KMADEConstant.TWELVE_STEP_IMAGE));
	...
	public KMADEReplaySimulationPanel() {
		...
		this.myTaskListScrollBorder = new TitledBorder(null, KMADEConstant.SCENARIO_REPLAY_MESSAGE, TitledBorder.CENTER,
				TitledBorder.TOP);
		...
		this.myScenarioListScrollBorder = new TitledBorder(null, KMADEConstant.RECORD_BUILDING_SCENARION_MESSAGE,
		...
		this.myAvailableActionoListScrollBorder = new TitledBorder(null,
				KMADEConstant.RECORD_AVAILABLE_ACTIONABLE_MESSAGE, TitledBorder.CENTER, TitledBorder.TOP);
		...
		this.myActionsBorder = new TitledBorder(null, KMADEConstant.ACTIONS_SIMULATION_MESSAGE, TitledBorder.CENTER,
				TitledBorder.TOP);
		...
		nextAction.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (currentReplaySimulation < myReplayModel.getSize()) {
					SimulationAdaptator.fireNextActionReplaySimulation(
							((TokenReplayScenarioSimulation) myReplayModel.get(currentReplaySimulation)));
				}
			}
		});
		...
		this.myReplayOptionsBorder = new TitledBorder(null, KMADEConstant.REPLAY_OPTIONS_MESSAGE, TitledBorder.LEFT,
				TitledBorder.TOP);
		...
		this.myTempoBorder = new TitledBorder(null, KMADEConstant.REPLAY_TEMPO_MESSAGE, TitledBorder.LEFT,
				TitledBorder.TOP);
	...
	public void startWaitController() {
		if (waitController == null || !waitController.isRunning()) {
			...
			Envelope envelope = new Envelope(TimingController.INFINITE, 0, Envelope.RepeatBehavior.FORWARD,
			...
			waitController.addTimingListener(new TimingListener() {
				...
				public void timerRepeated(TimingEvent arg0) {
					...
					waitController = null;
					SimulationAdaptator
							.playTask(((TokenReplayScenarioSimulation) myReplayModel.get(currentReplaySimulation)));
				}
			});
