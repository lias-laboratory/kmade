...
public class KMADEEditorMultimediaDialog extends JPropertiesEditorDialog implements ActionListener {
	...
	private static final ImageIcon PLAY_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.PLAY_IMAGE));

	private static final ImageIcon PAUSE_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.PAUSE_IMAGE));

	private static final ImageIcon PLAY_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.PLAY_MARK_IMAGE));

	private static final ImageIcon PAUSE_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.PAUSE_MARK_IMAGE));

	private static final ImageIcon START_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.START_MARK_IMAGE));

	private static final ImageIcon FINISH_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.FINISH_MARK_IMAGE));

	private static final ImageIcon INIT_START_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.INIT_START_MARK_IMAGE));

	private static final ImageIcon INIT_FINISH_MARK_IMAGE = new ImageIcon(
			KMADEEditorMultimediaDialog.class.getResource(KMADEConstant.INIT_FINISH_MARK_IMAGE));
