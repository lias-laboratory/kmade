...
public class KMADEInputUserExpressionAndConcreteObjectDialog extends JDialog {
	...
	private static final ImageIcon UNLOCK_USER = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.UNLOCK_IMAGE));

	private static final ImageIcon CLEAR_USER_VALUES = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.CLEAR_HISTORY_IMAGE));
	...
	public KMADEInputUserExpressionAndConcreteObjectDialog(Frame owner) {
		...
		panelPreconditionEdit
				.setBorder(BorderFactory.createTitledBorder(KMADEConstant.PRECONDITION_USER_EDITION_MESSAGE));
		...
		panelEffetsDeBordEdit
				.setBorder(BorderFactory.createTitledBorder(KMADEConstant.EFFETSDEBORD_USER_EDITION_MESSAGE));
