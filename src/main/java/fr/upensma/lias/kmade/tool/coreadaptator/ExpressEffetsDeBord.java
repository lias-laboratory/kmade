...
public class ExpressEffetsDeBord {
		...
		SwingWorker worker = new SwingWorker() {
			public Object construct() {
				...
				for (int i = 0; i < tacheToBeCreated.length && !ExpressEffetsDeBord.isCanceled(); i++) {
					String effetsdebord = tacheToBeCreated[i].getEffetsDeBordExpression().getFormalText();
	...
	public static void setEffetsDeBordDescription(Task task, String descriptionArea) {
