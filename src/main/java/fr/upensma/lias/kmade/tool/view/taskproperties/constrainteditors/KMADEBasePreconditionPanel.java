...
public class KMADEBasePreconditionPanel extends JPanel implements LanguageFactory {
	 ...
	 private static final long serialVersionUID = 2659692780990739523L;
	    ...
	    public KMADEBasePreconditionPanel() {
		...
		panelHaut
			.setBorder(BorderFactory
				.createTitledBorder(KMADEConstant.PRECONDITION_EDITION_MESSAGE));
		...
		panelDescription
			.setBorder(BorderFactory
				.createTitledBorder(KMADEConstant.PRECONDITION_TEXTUEL_EDITION_MESSAGE));
