...
public final class PrintAdaptator {
    ...
    public static void openPrintDialog(DefaultGraphModel myModel,
	    GraphLayoutCache lc) {
	GraphicEditorAdaptator.getMainFrame().getPrintingFrame().getTaskModel()
		.setModelToPrint(myModel, lc);
	...
	case 0: {
	    GraphicEditorAdaptator.getMainFrame().getPrintingFrame()
		    .getTaskModel().setScaleView(1.0);
	    GraphicEditorAdaptator.getMainFrame().getPrintingFrame()
		    .getTaskModel().makeTraitement();
	    break;
	}

	case 1: {
	    GraphicEditorAdaptator.getMainFrame().getPrintingFrame()
		    .getUserCards().makeTraitement();
	    break;
	}
	...
	context.put("FREQUENCYVALUE_TITLE",
	...
	context.put("INTERRUPTIBLE_TITLE",
		KMADEConstant.INTERRUPTIBLE_LABEL_NAME);
	context.put("DECLENCHEMENT_TITLE",
    ...
    private static String processStringUserCards(VelocityContext context,
