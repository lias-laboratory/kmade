...
public class KMADEObjectsToolBar extends JToolBar {
	...
	public AbstractAction newAbstractObject, removeAbstractObject, addAttribute, removeAttribute, cancel, newStack,
			newSet, newList, newUnique, newArray, editConcrete, deleteConcrete;

	public static final ImageIcon ADD_ABSTRACT_OBJECT = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.ADD_OBJECT_IMAGE));

	public static final ImageIcon REMOVE_ABSTRACT_OBJECT = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.REMOVE_OBJECT_IMAGE));
	...
	public static final ImageIcon NEW_STACK = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.GROUP_STACK_IMAGE));

	public static final ImageIcon NEW_SET = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.GROUP_SET_IMAGE));

	public static final ImageIcon NEW_LIST = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.GROUP_LIST_IMAGE));

	public static final ImageIcon NEW_UNIQUE = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.GROUP_SINGLETON_IMAGE));

	public static final ImageIcon NEW_ARRAY = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.GROUP_ARRAY_IMAGE));

	public static final ImageIcon EDIT_GROUP_IMAGE = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.EDIT_GROUP_IMAGE));

	public static final ImageIcon DELETE_GROUP_IMAGE = new ImageIcon(
			KMADEObjectsToolBar.class.getResource(KMADEConstant.DELETE_GROUP_IMAGE));
	...
	public KMADEObjectsToolBar() {
		...
		// ABSTRACT OBJECT
		// New abstract Object
		this.newAbstractObject = new AbstractAction(KMADEConstant.NEW_ABSTRACT_OBJECT_TEXT,
		...
		this.newAbstractObject.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_ABSTRACT_OBJECT_TEXT);
		this.newAbstractObject.setEnabled(false);
		this.add(newAbstractObject);

		// Remove Abstract Object
		this.removeAbstractObject = new AbstractAction(KMADEConstant.REMOVE_ABSTRACT_OBJECT_TEXT,
		...
		this.removeAbstractObject.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.REMOVE_ABSTRACT_OBJECT_TEXT);
		...
		// Add an attribute
		this.addAttribute = new AbstractAction(KMADEConstant.ADD_ATTRIBUTE, KMADEObjectsToolBar.ADD_ATTRIBUTE) {
		...
		this.addAttribute.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.ADD_ATTRIBUTE);
		this.addAttribute.setEnabled(false);
		this.add(addAttribute);

		// Remove the attribute
		this.removeAttribute = new AbstractAction(KMADEConstant.ADD_ATTRIBUTE, KMADEObjectsToolBar.REMOVE_ATTRIBUTE) {
		...
		this.removeAttribute.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.REMOVE_ATTRIBUTE);
		...
		// CONCRETE OBJECT
		// New stack
		this.newStack = new AbstractAction(KMADEConstant.NEW_STACK_ACTION_MESSAGE, KMADEObjectsToolBar.NEW_STACK) {
		...
		this.newStack.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_STACK_ACTION_MESSAGE);
		this.newStack.setEnabled(false);
		this.add(newStack);

		// New set
		this.newSet = new AbstractAction(KMADEConstant.NEW_SET_ACTION_MESSAGE, KMADEObjectsToolBar.NEW_SET) {
		...
		this.newSet.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_SET_ACTION_MESSAGE);
		this.newSet.setEnabled(false);
		this.add(newSet);

		// New array
		this.newArray = new AbstractAction(KMADEConstant.NEW_ARRAY_ACTION_MESSAGE, KMADEObjectsToolBar.NEW_ARRAY) {
		...
		this.newArray.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_ARRAY_ACTION_MESSAGE);
		this.newArray.setEnabled(false);
		this.add(newArray);

		// New list
		this.newList = new AbstractAction(KMADEConstant.NEW_LIST_ACTION_MESSAGE, KMADEObjectsToolBar.NEW_LIST) {
		...
		this.newList.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_LIST_ACTION_MESSAGE);
		this.newList.setEnabled(false);
		this.add(newList);

		// New singleton
		this.newUnique = new AbstractAction(KMADEConstant.NEW_SINGLETON_ACTION_MESSAGE,
		...
		this.newUnique.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.NEW_SINGLETON_ACTION_MESSAGE);
		...
		this.editConcrete = new AbstractAction(KMADEConstant.EDIT_GROUP_AND_CONCRETE_ACTION_MESSAGE,
		...
		this.deleteConcrete = new AbstractAction(KMADEConstant.DELETE_GROUP_AND_CONCRETE_ACTION_MESSAGE,
		...
		// Cancel
		this.cancel = new AbstractAction(KMADEConstant.CANCEL_MESSAGE, KMADEObjectsToolBar.CANCEL) {
		...
		this.cancel.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.CANCEL_MESSAGE);
