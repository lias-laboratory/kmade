...
public class KMADEConstant {
	...
	// Les mots affich� sur une t�che dans l'espace de t�che
	...
	public static String OPEN_EXPRESS_OK_FILE = "Chargement du projet K-MAD r�ussi : ";
	public static String OPEN_EXPRESS_NO_OK_FILE = "Chargement du projet K-MAD �chou� : ";
	...
	public static String OPEN_SIMULATION_MESSAGE = "Lancement de la bo�te de dialogue de simulation";
	...
	public static String NOT_SAME_VERSION = "La version que vous essay� de charger n'est pas la m�me que celle de l'outil";
