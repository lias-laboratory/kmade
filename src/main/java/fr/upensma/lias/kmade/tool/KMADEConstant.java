...
public class KMADEConstant {
	...
	public static void loadMessagesFromBundle() {
		...
		PROTOTYPING_TOOL_SUBTASK_DECOMP_TOOLTIP1 =KMADeMain.messages.getString("PROTOTYPING_TOOL_SUBTASK_DECOMP_TOOLTIP1");
		PROTOTYPING_TOOL_SUBTASK_DECOMP_TOOLTIP2 = KMADeMain.messages.getString("PROTOTYPING_TOOL_SUBTASK_DECOMP_TOOLTIP2");
		PROTOTYPING_TOOL_SUBTASK_TERMINAL_TOOLTIP =KMADeMain.messages.getString("PROTOTYPING_TOOL_SUBTASK_TERMINAL_TOOLTIP");
		PROTOTYPING_TOOL_SUBTASK_DESCRIPTION_TOOLTIP = KMADeMain.messages.getString("PROTOTYPING_TOOL_SUBTASK_DESCRIPTION_TOOLTIP");
		...
		PROTOTYPING_TOOL_PRECONDITION_TEXT_PANE = KMADeMain.messages.getString("PROTOTYPING_TOOL_PRECONDITION_TEXT_PANE");
