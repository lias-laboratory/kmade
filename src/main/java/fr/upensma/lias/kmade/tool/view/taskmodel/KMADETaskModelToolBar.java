...
public class KMADETaskModelToolBar extends JPanel {
    ...
    public static final ImageIcon ZOOMIN_IMAGE_ICON = new ImageIcon(
	    KMADETaskModelToolBar.class
		    .getResource(KMADEConstant.ZOOM_IN_IMAGE));

    public static final ImageIcon ZOOMOUT_IMAGE_ICON = new ImageIcon(
	    KMADETaskModelToolBar.class
		    .getResource(KMADEConstant.ZOOM_OUT_IMAGE));
	...
	unknownTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
	...
	abstractTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
	...
	userTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
	...
	feedbackTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
	...
	interactionTaskAction = new AbstractAction("",
		INTERACTION_TASK_IMAGE_ICON) {
	    private static final long serialVersionUID = 838662422873173261L;
	...
	// Zoom globale
	globalGraph = new AbstractAction("",
	...
	globalGraph.putValue(AbstractAction.SHORT_DESCRIPTION,
	...
	// Magnetisme
	magnetismAction = new AbstractAction("",
		KMADETaskModelToolBar.MAGN_IMAGE_ICON) {
	...
	magnetismAction.putValue(AbstractAction.SHORT_DESCRIPTION,
		KMADEConstant.MAGNET_OPTION_ACTION_MESSAGE);
	magnetOption = new JToggleButton(magnetismAction);
	toolbar.add(magnetOption);

	// Justification
	justificationAction = new AbstractAction("",
		KMADETaskModelToolBar.JUSTIFY_IMAGE_ICON) {
	    private static final long serialVersionUID = 4000465475546408455L;
	...
	justificationAction.putValue(AbstractAction.SHORT_DESCRIPTION,
		KMADEConstant.JUSTIFY_OPTION_ACTION_MESSAGE);
	toolbar.add(justificationAction);

	// Appliquer le même exécutant
	sameExecutant = new AbstractAction("",
		KMADETaskModelToolBar.UNIFORM_IMAGE_ICON) {
	    private static final long serialVersionUID = 4000465475546408455L;
	...
	sameExecutant.putValue(AbstractAction.SHORT_DESCRIPTION,
		KMADEConstant.SAME_EXECUTANT_MESSAGE);
	...
	myShowOrNotTaskLabelToggleButton = new JToggleButton(
	...
	myShowOrNotTaskColorLabelToggleButton = new JToggleButton(
	...
	toolbar.addSeparator();
	openSimulationAction = new AbstractAction("",
		KMADETaskModelToolBar.OPEN_SIMULATION_ICON) {
	    private static final long serialVersionUID = 4000465475546408455L;
	...
	openSimulationAction.putValue(AbstractAction.SHORT_DESCRIPTION,
		KMADEConstant.OPEN_SIMULATION_MESSAGE);
