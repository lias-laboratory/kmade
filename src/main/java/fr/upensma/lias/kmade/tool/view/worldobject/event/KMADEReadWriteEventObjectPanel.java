 ...
 */
public class KMADEReadWriteEventObjectPanel extends JScrollPane implements
	LanguageFactory {
	...
	String[] columnNames = { KMADEConstant.EVENT_NAME_TABLE,
		KMADEConstant.EVENT_DESCRIPTION_TABLE };
	...
	myTitledBorder = new TitledBorder(null, KMADEConstant.EVENT_TITLE_NAME,
	...
	public void keyPressed(KeyEvent ke) {
		...
		boolean state = GraphicEditorAdaptator.removeSelectedItem(
			"Event", r, myTableListModel.getListTableData(),
			GraphicEditorAdaptator.getMainFrame(),
