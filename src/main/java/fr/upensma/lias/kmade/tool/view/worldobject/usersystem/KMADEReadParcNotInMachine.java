 ...
 */
public class KMADEReadParcNotInMachine extends JScrollPane implements LanguageFactory {

    private static final long serialVersionUID = -5233153518414916256L;

    private KMADEJTable table;

    private myModel modele;

    public KMADEReadParcNotInMachine() {
	modele = new myModel();
	...
	table.addKeyListener(new KeyListener() {
		...
		if (ke.getKeyChar() == KeyEvent.VK_DELETE
			...
			KMADEMainFrame.getProjectPanel().getMachinePanel()
				.addParcToActiveMachine(oidOrga);
		    }
		    KMADEMainFrame.getProjectPanel().getMachinePanel()
			    .refreshActiveMachine();
	...
	public String getColumnName(int i) {
	    switch (i) {
	    case 0:
		return KMADEConstant.PARCMACHINES_NAME_TABLE;
	    case 1:
		return KMADEConstant.PARCMACHINES_DESCRIPTION_TABLE;
	    case 2:
		return KMADEConstant.PARCMACHINES_IMAGE_TABLE;
	    case 3:
		return KMADEConstant.PARCMACHINES_MACHINE_TABLE;
	    default:
		return "";
	    }
	}
	...
	this.setBorder(new TitledBorder(null, KMADEConstant.MACHINE_OTHERS
		+ " " + KMADEConstant.MACHINE_PARCS_TABLE + " : " + name,
	...
	this.removeAllParc();
	// les organisations {oid, name, descritpion, image path,nom des
	// machines}
