...
public class JPropertiesTable extends JScrollPane implements MouseInputListener {
	...
	public JPropertiesTable(DefaultPropertiesTableModel p, boolean editable) {
		...
		refTable.getTableHeader().setDefaultRenderer(new DefaultTableCellRenderer() {
			...
			public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
				...
				case COLOR_TEXT: {
					...
					if (value instanceof Color) {
						...
						((JLabel) myComponent).setText(
								"R:" + myColor.getRed() + ", G:" + myColor.getGreen() + ", B:" + myColor.getBlue());
				...
				case CHECK_TEXT: {
					String[] checkText = (String[]) (refModel.getValueAt(row,
				...
				boolean editable = (Boolean) (refModel.getValueAt(row,
	...
	class MyCustomTableCellEditor extends AbstractCellEditor implements TableCellEditor {
		...
		public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row,
			...
			case LONG_TEXT: {
				state = 1;
				JPropertiesEditorDialog refDialog = (JPropertiesEditorDialog) (refModel.getValueAt(row,
	...
	private boolean canResize(TableColumn column) {
		return column != null && refTable.getTableHeader().getResizingAllowed() && column.getResizable();
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		boolean headerLeftToRight = refTable.getTableHeader().getComponentOrientation().isLeftToRight();
		...
		if (resizingColumn != null) {
			...
			if (!container.getComponentOrientation().isLeftToRight() && !headerLeftToRight) {
				if (refTable != null) {
					...
					if ((newHeaderWidth >= viewportWidth) && (refTable.getAutoResizeMode() == JTable.AUTO_RESIZE_OFF)) {
