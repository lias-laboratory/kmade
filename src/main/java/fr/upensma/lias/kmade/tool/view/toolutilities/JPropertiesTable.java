...
public class JPropertiesTable extends JScrollPane implements MouseInputListener {
    ...
    public JPropertiesTable(DefaultPropertiesTableModel p, boolean editable) {
        ...
        refTable.getColumnModel().getColumn(0).setCellRenderer(new DefaultTableCellRenderer() {
            private static final long serialVersionUID = 4038866614648102821L;

            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                DefaultPropertiesTableModel refModel = (DefaultPropertiesTableModel)table.getModel();
                int myValue = (Integer) (refModel.getValueAt(row, DefaultPropertiesTableModel.COLUMN_TYPE_INDEX));
                if (myValue == NONE_TEXT) {
                		JLabel myLabel = new JLabel();
                		myLabel.setOpaque(true);
                		if (isSelected) {
                			myLabel.setBackground(KMADEConstant.ACTIVE_SELECTION.darker());               
                		} else {
                    		myLabel.setBackground(JPropertiesTable.this.getBackground().darker());                			
                		}
                		myLabel.setPreferredSize(new Dimension(0,20));
                     myLabel.setText((String)(refModel.getValueAt(row, DefaultPropertiesTableModel.COLUMN_NAME_INDEX)));
        ...
        refTable.getColumnModel().getColumn(1).setCellRenderer(new DefaultTableCellRenderer() {
            private static final long serialVersionUID = 1348784031812214529L;
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                switch (myValue) {
                    ...
                    case COLOR_TEXT : {
                    		...
                    		if (value instanceof Color) {
                    			...
                    			((JLabel)myComponent).setText("R:" + myColor.getRed() + ", G:" + myColor.getGreen() + ", B:" + myColor.getBlue());
                    ...
                    case CHECK_TEXT: {                        
                        String[] checkText = (String[])(refModel.getValueAt(row, DefaultPropertiesTableModel.COLUMN_COMBOVALUE_INDEX));
                ...
                myComponent.setOpaque(true);                
                if (isSelected) {
                    myComponent.setBackground(KMADEConstant.ACTIVE_SELECTION);
                } else {
                    myComponent.setBackground(KMADEConstant.ACTIVE_PANE); 
                }
                
                boolean editable = (Boolean)(refModel.getValueAt(row, DefaultPropertiesTableModel.COLUMN_ISEDITABLE_INDEX));
        ...
        refTable.getColumnModel().getColumn(1).setCellEditor(new MyCustomTableCellEditor());
    ...
    class MyCustomTableCellEditor extends AbstractCellEditor implements
        ...
        public Component getTableCellEditorComponent(JTable table,Object value, boolean isSelected, int row, int column) {
            ...
            switch (myValue) {
                ...
                case LONG_TEXT : {
                    state = 1;
                    JPropertiesEditorDialog refDialog = (JPropertiesEditorDialog)(refModel.getValueAt(row,DefaultPropertiesTableModel.COLUMN_EDITOR_INDEX));
        ...
        public Object getCellEditorValue() {
            switch (state) {
                case 0 : return myTextfield.getText();
                case 1 : return "";
                case 2 : return myComboBox.getSelectedItem();
                default : return "";
            }
        }
    ...
    public  Cursor resizeCursor = Cursor.getPredefinedCursor(Cursor.E_RESIZE_CURSOR); 
    ...
    private boolean canResize(TableColumn column){ 
        return column != null 
                && refTable.getTableHeader().getResizingAllowed() 
                && column.getResizable(); 
    } 
    ...
    private TableColumn getResizingColumn(Point p, int column){ 
        ...
        if(columnIndex == -1) 
            return null; 
        return refTable.getTableHeader().getColumnModel().getColumn(columnIndex); 
    } 
    ...
    public void mouseMoved(MouseEvent e){ 
        if(canResize(getResizingColumn(e.getPoint())) 
           != (refTable.getCursor() == resizeCursor)){ 
            swapCursor(); 
        } 
    } 
    ...
    public void mouseDragged(MouseEvent e){ 
        ...
        TableColumn resizingColumn = refTable.getTableHeader().getResizingColumn(); 
 
        boolean headerLeftToRight = 
            refTable.getTableHeader().getComponentOrientation().isLeftToRight(); 
        ...
        if(resizingColumn != null){ 
            ...
            if((refTable.getTableHeader().getParent() == null) 
               || ((container = refTable.getTableHeader().getParent().getParent()) == null) 
