...
public class KMADEPreferencesDialog extends JDialog {
	...
	generalAction = new AbstractAction(
		KMADEConstant.GENERAL_TABBEDPANE_TITLE_NAME) {
	...
	toolbar.add(button);
	taskAction = new AbstractAction(
		KMADEConstant.TASK_MODEL_EDITOR_TABBED_NAME) {
	...
	generalAction.putValue(AbstractAction.NAME,
		KMADEConstant.GENERAL_TABBEDPANE_TITLE_NAME);
	taskAction.putValue(AbstractAction.NAME,
		KMADEConstant.TASK_MODEL_EDITOR_TABBED_NAME);
	objectAction.putValue(AbstractAction.NAME,
		KMADEConstant.TREE_EDITOR_TABBED_NAME);
    }
}
