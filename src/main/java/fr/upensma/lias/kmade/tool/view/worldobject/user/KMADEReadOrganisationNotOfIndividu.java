 ...
 */
public class KMADEReadOrganisationNotOfIndividu extends JScrollPane implements
	LanguageFactory {
	...
	table.addKeyListener(new KeyListener() {
		...
		if (ke.getKeyChar() == KeyEvent.VK_DELETE
			...
			KMADEMainFrame.getProjectPanel().tableIndividu()
				.addOrganizationToActiveIndividu(oidOrga);
		    }
		    KMADEMainFrame.getProjectPanel().tableIndividu()
			    .refreshActiveIndividu();
	...
	this.setBorder(new TitledBorder(null, KMADEConstant.INDIVIDU_OTHERS
		+ " " + KMADEConstant.INDIVIDU_ORGANIZATION_TABLE + " : "
		+ name, TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION));
