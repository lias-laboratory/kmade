...
public class KMADEPreferencesTaskTreePanel extends javax.swing.JPanel {
	...
	this.heightTreeComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	heightTreeComboBox.setModel(new DefaultComboBoxModel(new String[] {/*
									    * "90",
									    * "100"
									    * ,
									    * "110"
	...
	this.orientationtTreeComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	orientationtTreeComboBox.setModel(new DefaultComboBoxModel(
		new String[] { "1", "2", "3", "4", "5", "6", "7" }));
	this.orientationtTreeComboBox.setEnabled(false);

	this.distanceNodaleComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	// distanceNodaleComboBox.setModel(new DefaultComboBoxModel(new String[]
	...
	this.colorSelectTreeComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	colorSelectTreeComboBox.setModel(new DefaultComboBoxModel(new String[] {
	...
	this.orthogonalityTreeCheckBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
	...
	agencementPanel
		.setBorder(BorderFactory
			.createTitledBorder(KMADEConstant.TASK_TREE_PANEL_LAYOUT_PANEL_NAME));
	distanceNodaleLabel
		.setText(KMADEConstant.TASK_TREE_PANEL_LAYOUT_DISTANCE_LABEL
			+ " : ");

	colorSelectTreeLabel
		.setText(KMADEConstant.TASK_TREE_PANEL_LAYOUT_SELECTION_COLOR_LABEL
			+ " : ");

	orientationTreeLabel
		.setText(KMADEConstant.TASK_TREE_PANEL_LAYOUT_ORIENTATION_LABEL
			+ " : ");

	heightTreeLabel
		.setText(KMADEConstant.TASK_TREE_PANEL_LAYOUT_LEVEL_DISTANCE_LABEL
			+ " : ");

	org.jdesktop.layout.GroupLayout agencementPanelLayout = new org.jdesktop.layout.GroupLayout(
		agencementPanel);
	agencementPanel.setLayout(agencementPanelLayout);
	agencementPanelLayout
		.setHorizontalGroup(agencementPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(agencementPanelLayout
				...
				.add(agencementPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING,
						false)
					.add(orientationtTreeComboBox, 0, 110,
						Short.MAX_VALUE)
					.add(heightTreeComboBox, 0, 110,
						Short.MAX_VALUE)
					.add(distanceNodaleComboBox, 0, 110,
						Short.MAX_VALUE)
					.add(colorSelectTreeComboBox, 0, 110,
						Short.MAX_VALUE))
				.add(82, 82, 82)));
	agencementPanelLayout
		.setVerticalGroup(agencementPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
	...
	optionsPanel
		.setBorder(BorderFactory
			.createTitledBorder(KMADEConstant.TASK_TREE_PANEL_OPTIONS_PANEL_NAME));
	orthogonalityTreeCheckBox
		.setText(KMADEConstant.TASK_TREE_PANEL_OPTIONS_ORTHOGONAL_EDGE_LABEL);
	orthogonalityTreeCheckBox.setBorder(BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	optionsPanelLayout.setHorizontalGroup(optionsPanelLayout
		...
		.add(optionsPanelLayout.createSequentialGroup()
			.addContainerGap().add(orthogonalityTreeCheckBox)
	...
	layout.setHorizontalGroup(layout
		...
		.add(agencementPanel,
			...
			Short.MAX_VALUE)
		.add(org.jdesktop.layout.GroupLayout.TRAILING, optionsPanel,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
			Short.MAX_VALUE));
