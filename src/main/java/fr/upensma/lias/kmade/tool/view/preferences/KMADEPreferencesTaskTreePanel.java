...
public class KMADEPreferencesTaskTreePanel extends javax.swing.JPanel {
	...
	public KMADEPreferencesTaskTreePanel() {
		...
		// //////////////modifi� /////////////////
		distanceNodaleComboBox.setModel(new DefaultComboBoxModel(
				new String[] { "60", "70", "80", "90", "100", "110", "120", "150", "200", "250", "500" }));
		...
		colorSelectTreeComboBox
				.setModel(new DefaultComboBoxModel(new String[] { KMADEConstant.COLOR_BLACK, KMADEConstant.COLOR_RED,
	...
	private void initComponents() {
		...
		agencementPanelLayout.setHorizontalGroup(agencementPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(agencementPanelLayout.createSequentialGroup().addContainerGap().add(agencementPanelLayout
						.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(agencementPanelLayout.createSequentialGroup().add(orientationTreeLabel).add(31, 31, 31))
						.add(colorSelectTreeLabel).add(distanceNodaleLabel).add(heightTreeLabel)).add(0, 0, 0)
		...
		agencementPanelLayout
				.setVerticalGroup(agencementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(org.jdesktop.layout.GroupLayout.TRAILING, agencementPanelLayout.createSequentialGroup()
								.add(agencementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(orientationTreeLabel).add(orientationtTreeComboBox,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(agencementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(heightTreeLabel).add(heightTreeComboBox,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(agencementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(distanceNodaleLabel).add(distanceNodaleComboBox,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(agencementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(colorSelectTreeLabel).add(colorSelectTreeComboBox,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
								.add(11, 11, 11)));
		...
		optionsPanelLayout
				.setHorizontalGroup(optionsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(optionsPanelLayout.createSequentialGroup().addContainerGap().add(orthogonalityTreeCheckBox)
								.addContainerGap(141, Short.MAX_VALUE)));
		optionsPanelLayout
				.setVerticalGroup(optionsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(optionsPanelLayout.createSequentialGroup().add(orthogonalityTreeCheckBox)
		...
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(layout.createSequentialGroup().add(agencementPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
