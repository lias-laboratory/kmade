 ...
 */
public class KMADEReadOrganisationOfIndividu extends JScrollPane implements
	LanguageFactory {
	...
	table.addKeyListener(new KeyListener() {
		...
		if (ke.getKeyChar() == KeyEvent.VK_DELETE
			...
			KMADEMainFrame.getProjectPanel().tableIndividu()
				.removeOrganizationToActiveIndividu(oidOrga);
		    }
		    KMADEMainFrame.getProjectPanel().tableIndividu()
	...
	this.setBorder(new TitledBorder(null,
		KMADEConstant.INDIVIDU_ORGANIZATION_TABLE + " : " + name,
