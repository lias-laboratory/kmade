...
public class KMADEToolToolBar extends JPanel implements LanguageFactory {
	...
	public static final ImageIcon SHOW_GRILLE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.SHOW_GRID_IMAGE));

	public static final ImageIcon HIDE_GRILLE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.HIDE_GRID_IMAGE));

	public static final ImageIcon SHOW_RULE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.SHOW_RULE_IMAGE));

	public static final ImageIcon HIDE_RULE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.HIDE_RULE_IMAGE));

	public static final ImageIcon CHOICE_GRID_SIZE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.CHOICE_GRID_SIZE_IMAGE));

	public static final ImageIcon UNDO = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.UNDO_IMAGE));

	public static final ImageIcon REDO = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.REDO_IMAGE));

	public static final ImageIcon CUT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.CUT_IMAGE));

	public static final ImageIcon COPY = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.COPY_IMAGE));

	public static final ImageIcon PASTE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.PASTE_IMAGE));

	public static final ImageIcon DELETE = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.DELETE_IMAGE));

	public static final ImageIcon PRINT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.PRINT_IMAGE));

	public static final ImageIcon PRINT_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.PRINT_PREVIEW_IMAGE));

	public static final ImageIcon PRINT_LAYOUT = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.PRINT_LAYOUT_IMAGE));

	public static final ImageIcon NEW_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.NEW_PROJECT_IMAGE));

	public static final ImageIcon OPEN_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.OPEN_PROJECT_IMAGE));

	public static final ImageIcon CLOSE_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.CLOSE_PROJECT_IMAGE));

	public static final ImageIcon SAVE_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.SAVE_PROJECT_IMAGE));

	public static final ImageIcon OVERVIEW_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.OVERVIEW_IMAGE));

	public static final ImageIcon CLIPBOARD_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.CLIPBOARD_IMAGE));

	public static final ImageIcon OPTIONS_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.OPTIONS_IMAGE));

	public static final ImageIcon PROJECT_IMAGE_ICON = new ImageIcon(
			GraphicEditorAdaptator.class
			.getResource(KMADEConstant.PROJECT_IMAGE));
	...
	private AbstractAction mySaveItemsAction;

	private AbstractAction mySaveItemsAsAction;

	private AbstractAction myLoadItemsAction;

	private AbstractAction myEditItemsAction;
	...
	public KMADEToolToolBar() {
		...
		projectAction = new AbstractAction(
				KMADEConstant.NEW_PROJECT_ACTION_MESSAGE, NEW_PROJECT) {
		...
		projectAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.NEW_PROJECT_ACTION_MESSAGE);
		...
		loadAction = new AbstractAction(
				KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE, OPEN_PROJECT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		loadAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE);
		toolbar.add(loadAction);
		myFileMenu.add(loadAction);

		// Sauvegarder un projet.
		mySaveAction = new AbstractAction(
				KMADEConstant.SAVE_PROJECT_ACTION_MESSAGE, SAVE_PROJECT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		mySaveAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SAVE_PROJECT_ACTION_MESSAGE);
		mySaveAction.putValue(Action.ACCELERATOR_KEY,
		...
		// Fermer projet
		myCloseAction = new AbstractAction(
				KMADEConstant.CLOSE_PROJECT_ACTION_MESSAGE, CLOSE_PROJECT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myCloseAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CLOSE_PROJECT_ACTION_MESSAGE);
		...
		myOverviewPrintAction = new AbstractAction(
				KMADEConstant.PRINT_PREVIEW_ACTION_MESSAGE,
				KMADEToolToolBar.PRINT_PREVIEW) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myOverviewPrintAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PRINT_PREVIEW_ACTION_MESSAGE);
		toolbar.add(myOverviewPrintAction);
		myFileMenu.add(myOverviewPrintAction);

		// Imprimer modèle de tâches.
		myPrintAction = new AbstractAction(
				KMADEConstant.PRINT_PROJECT_ACTION_MESSAGE,
				KMADEToolToolBar.PRINT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myPrintAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PRINT_PROJECT_ACTION_MESSAGE);
...
/*AG*/
		...
		// Cut
		myCutAction = new AbstractAction(KMADEConstant.CUT_ACTION_MESSAGE,
				KMADEToolToolBar.CUT) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		myCutAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CUT_ACTION_MESSAGE);
		myCutAction.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_T);
		myCutAction.putValue(Action.ACCELERATOR_KEY,
				KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
		toolbar.add(myCutAction);
		myFileMenu.add(myCutAction);

		// Copy
		myCopyAction = new AbstractAction(KMADEConstant.COPY_ACTION_MESSAGE,
				KMADEToolToolBar.COPY) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		myCopyAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.COPY_ACTION_MESSAGE);
		myCopyAction.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_C);
		myCopyAction.putValue(Action.ACCELERATOR_KEY,
				KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
		toolbar.add(myCopyAction);
		myFileMenu.add(myCopyAction);

		// Paste
		myPasteAction = new AbstractAction(KMADEConstant.PASTE_ACTION_MESSAGE,
				KMADEToolToolBar.PASTE) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		myPasteAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PASTE_ACTION_MESSAGE);
		myPasteAction.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_V);
		myPasteAction.putValue(Action.ACCELERATOR_KEY,
		...
		// Find Replace
		this.findReplaceAction = new AbstractAction(
				KMADEConstant.FIND_REPLACE_ACTION_MESSAGE) {
		...
		findReplaceAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.FIND_REPLACE_ACTION_MESSAGE);
		findReplaceAction.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_F);
		findReplaceAction.putValue(Action.ACCELERATOR_KEY,
				KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK));
		myFileMenu.add(findReplaceAction);
		myFileMenu.addSeparator();

		// Supprimer
		myRemoveAction = new AbstractAction(
				KMADEConstant.DELETE_CELL_ACTION_MESSAGE,
				KMADEToolToolBar.DELETE) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myRemoveAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.DELETE_CELL_ACTION_MESSAGE);
		myRemoveAction.putValue(Action.ACCELERATOR_KEY,
		...
		myOverviewClipboardAction = new AbstractAction(
				KMADEConstant.SHOW_CLIPBOARD_MESSAGE,
				KMADEToolToolBar.CLIPBOARD_PREVIEW) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		myOverviewClipboardAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SHOW_CLIPBOARD_MESSAGE);
		myOverviewClipboardToggleButton = new JToggleButton(
				myOverviewClipboardAction);
		...
		myMenuBar.add(myFileMenu);
		mySetProjectAction = new AbstractAction(
				KMADEConstant.SET_EXISTING_PROJECT_SHORT_MESSAGE,
				KMADEToolToolBar.PROJECT_IMAGE_ICON) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		mySetProjectAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SET_EXISTING_PROJECT_LONG_MESSAGE);
		toolbar.add(mySetProjectAction);
		myFileMenu.add(mySetProjectAction);

		// Liste des entités
		entityListAction = new AbstractAction(
				KMADEConstant.ENTITY_LIST_ACTION_MESSAGE,
				KMADEToolToolBar.ENTITY_LIST_IMAGE_ICON) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		entityListAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.ENTITY_LIST_ACTION_MESSAGE);
		toolbar.add(entityListAction);

		// Editer tâche simplement.
		myEditTaskAction = new AbstractAction(
				KMADEConstant.EDIT_TASK_ACTION_MESSAGE) {
		...
		myEditTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.EDIT_TASK_ACTION_MESSAGE);
		myFileMenu.add(myEditTaskAction);

		// Editer tâche complexe.
		myCompleteEditTaskAction = new AbstractAction(
				KMADEConstant.COMPLETE_EDIT_TASK_ACTION_MESSAGE) {
		...
		myCompleteEditTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.COMPLETE_EDIT_TASK_ACTION_MESSAGE);
		...
		myMenuBar.add(myFileMenu);
		protoTaskAction = new AbstractAction(KMADEConstant.PROTOTASK_TOOL_MENU_TITLE) {
		...
		protoTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.PROTOTASK_TOOL_MENU_TOOLTIP);
		...
		simulationAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SIMULATION_ACTION_MESSAGE);
		simulationAction.setEnabled(true);
		myFileMenu.add(simulationAction);

		statisticAction = new AbstractAction(
				KMADEConstant.INTERROGATION_ACTION_MESSAGE) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		statisticAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.INTERROGATION_ACTION_MESSAGE);
		statisticAction.setEnabled(false);
		myFileMenu.add(statisticAction);

		checkAction = new AbstractAction(
				KMADEConstant.CHECK_COHERENCE_ACTION_MESSAGE) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		checkAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CHECK_COHERENCE_ACTION_MESSAGE);
		...
		searchAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SEARCH_ACTION_MESSAGE);
		...
		// * Objects
		// **
		myFileMenu = new JMenu(KMADEConstant.OBJECT_MENU_MESSAGE);
		myMenuBar.add(myFileMenu);

		// Load Items
		myLoadItemsAction = new AbstractAction(KMADEConstant.OPEN_ITEMS_FILE,
				OPEN_PROJECT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myLoadItemsAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE);
		myFileMenu.add(myLoadItemsAction);

		// Save objects
		this.mySaveItemsAction = new AbstractAction(
		...
		mySaveItemsAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SAVE_OBJECT_ACTION_MESSAGE);
		myFileMenu.add(mySaveItemsAction);

		// Save objects as
		this.mySaveItemsAsAction = new AbstractAction(
				KMADEConstant.SAVE_OBJECT_AS_ACTION_MESSAGE) {
			...
			public void actionPerformed(ActionEvent e) {
				if (!activeMenu())
					KMADeAdaptator.saveItemsXMLAs();
			}
		};
		mySaveItemsAsAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SAVE_OBJECT_ACTION_MESSAGE);
		myFileMenu.add(mySaveItemsAsAction);
		...
		this.myEditItemsAction = new AbstractAction(
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				KMADeAdaptator.openObjectDialogView();
			}
		};
		...
		myGridAction = new AbstractAction(
				KMADEConstant.HIDE_GRID_ACTION_MESSAGE,
				KMADEToolToolBar.SHOW_GRILLE) {
			private static final long serialVersionUID = -3565098144261030486L;
		...
		myGridAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.HIDE_GRID_ACTION_MESSAGE);
		myFileMenu.add(myGridAction);

		// Options d'affichage : modifier le grain de la grille.
		mySetGridAction = new AbstractAction(
				KMADEConstant.CHOICE_GRID_SIZE_MESSAGE,
		...
		mySetGridAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CHOICE_GRID_SIZE_MESSAGE);
		myFileMenu.add(mySetGridAction);

		// Options d'affichage : cacher/montrer la r�gle.
		myRuleAction = new AbstractAction(
				KMADEConstant.SHOW_RULE_ACTION_MESSAGE,
				KMADEToolToolBar.SHOW_RULE) {
		...
		myRuleAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SHOW_RULE_ACTION_MESSAGE);
		myFileMenu.add(myRuleAction);

		// Fenêtre d'aperçu
		myOverviewWindowAction = new AbstractAction(
				KMADEConstant.PREVIEW_WINDOW_ACTION_MESSAGE, OVERVIEW_PREVIEW) {
		...
		myPreferenceTool = new AbstractAction(
				KMADEConstant.PREFERENCE_ACTION_MESSAGE, OPTIONS_PREVIEW) {
			private static final long serialVersionUID = 5128574049819721220L;
		...
		myPreferenceTool.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PREFERENCE_ACTION_MESSAGE);
		...
		modeleAction = new AbstractAction(
				KMADEConstant.HELP_MODEL_ACTION_MESSAGE) {
			private static final long serialVersionUID = -7001694110308248140L;
		...
		debugAction = new AbstractAction(
				KMADEConstant.DEBUG_INFO_ACTION_MESSAGE) {
			private static final long serialVersionUID = -7001694110308248140L;
	...
	public void setEnabledGrid() {
		myGridAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.HIDE_GRID_ACTION_MESSAGE);
		myGridAction.putValue(AbstractAction.NAME,
				KMADEConstant.HIDE_GRID_ACTION_MESSAGE);
		myGridAction.putValue(AbstractAction.SMALL_ICON,
				KMADEToolToolBar.SHOW_GRILLE);
	}

	public void setDisabledGrid() {
		myGridAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SHOW_GRID_ACTION_MESSAGE);
		myGridAction.putValue(AbstractAction.NAME,
				KMADEConstant.SHOW_GRID_ACTION_MESSAGE);
		myGridAction.putValue(AbstractAction.SMALL_ICON,
				KMADEToolToolBar.HIDE_GRILLE);
	}

	public void setEnabledRule() {
		myRuleAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.HIDE_RULE_ACTION_MESSAGE);
		myRuleAction.putValue(AbstractAction.NAME,
				KMADEConstant.HIDE_RULE_ACTION_MESSAGE);
		myRuleAction.putValue(AbstractAction.SMALL_ICON,
				KMADEToolToolBar.SHOW_RULE);
	}
	...
	public void noProjectViewState() {
		...
		this.mySaveItemsAction.setEnabled(false);
		this.mySaveItemsAsAction.setEnabled(false);
		this.myLoadItemsAction.setEnabled(false);
		this.myEditItemsAction.setEnabled(false);
		//
	...
	public void existProjectViewState() {
		...
		// ADDED by Joachim TROUVERIE
		this.myLoadItemsAction.setEnabled(true);
		this.mySaveItemsAction.setEnabled(true);
		this.mySaveItemsAsAction.setEnabled(true);
		this.myEditItemsAction.setEnabled(true);
	}
	...
	public JPopupMenu createPopupMenuForAdd(final Point pt) {
		...
		AbstractAction myAction = new AbstractAction(
				KMADEConstant.NEW_UNKNOWN_TASK_ACTION_MESSAGE,
				KMADETaskModelToolBar.UNKNOWN_TASK_IMAGE_ICON) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myAction = new AbstractAction(
				KMADEConstant.NEW_ABSTRACT_TASK_ACTION_MESSAGE,
				KMADETaskModelToolBar.ABSTRACT_TASK_IMAGE_ICON) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myAction = new AbstractAction(
				...
				KMADETaskModelToolBar.USER_TASK_IMAGE_ICON) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myAction = new AbstractAction(
				...
				KMADETaskModelToolBar.FEEDBACK_TASK_IMAGE_ICON) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myAction = new AbstractAction(
				...
				KMADETaskModelToolBar.INTERACTION_TASK_IMAGE_ICON) {
			private static final long serialVersionUID = 838662422873173261L;
	...
	public void notifLocalisationModification() {
		modeleAction.putValue(AbstractAction.NAME,
				KMADEConstant.HELP_MODEL_ACTION_MESSAGE);
		toolAction.putValue(AbstractAction.NAME,
				KMADEConstant.DEBUG_INFO_ACTION_MESSAGE);
		debugAction.putValue(AbstractAction.NAME,
				KMADEConstant.DEBUG_INFO_ACTION_MESSAGE);
		aboutAction.putValue(AbstractAction.NAME,
				KMADEConstant.ABOUT_TITLE_NAME);
		simulationAction.putValue(AbstractAction.NAME,
				KMADEConstant.SIMULATION_ACTION_MESSAGE);
		simulationAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SIMULATION_ACTION_MESSAGE);
		statisticAction.putValue(AbstractAction.NAME,
				KMADEConstant.INTERROGATION_ACTION_MESSAGE);
		statisticAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.INTERROGATION_ACTION_MESSAGE);
		checkAction.putValue(AbstractAction.NAME,
				KMADEConstant.CHECK_COHERENCE_ACTION_MESSAGE);
		checkAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CHECK_COHERENCE_ACTION_MESSAGE);
		redoAction.putValue(AbstractAction.NAME,
				KMADEConstant.REDO_ACTION_MESSAGE);
		redoAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.REDO_ACTION_MESSAGE);
		undoAction.putValue(AbstractAction.NAME,
				KMADEConstant.UNDO_ACTION_MESSAGE);
		undoAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.UNDO_ACTION_MESSAGE);
		projectAction.putValue(AbstractAction.NAME,
				KMADEConstant.NEW_PROJECT_ACTION_MESSAGE);
		projectAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.NEW_PROJECT_ACTION_MESSAGE);
		exitAction.putValue(AbstractAction.NAME,
				KMADEConstant.EXIT_ACTION_MESSAGE);
		loadAction.putValue(AbstractAction.NAME,
				KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE);
		loadAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE);
		myGridAction.putValue(AbstractAction.NAME,
		...
		myRuleAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SHOW_RULE_ACTION_MESSAGE);
		myEditTaskAction.putValue(AbstractAction.NAME,
				KMADEConstant.EDIT_TASK_ACTION_MESSAGE);
		myEditTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.EDIT_TASK_ACTION_MESSAGE);
		myCompleteEditTaskAction.putValue(AbstractAction.NAME,
				KMADEConstant.COMPLETE_EDIT_TASK_ACTION_MESSAGE);
		myCompleteEditTaskAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.COMPLETE_EDIT_TASK_ACTION_MESSAGE);
		myCutAction.putValue(AbstractAction.NAME,
				KMADEConstant.CUT_ACTION_MESSAGE);
		myCutAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CUT_ACTION_MESSAGE);
		myCopyAction.putValue(AbstractAction.NAME,
				KMADEConstant.COPY_ACTION_MESSAGE);
		myCopyAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.COPY_ACTION_MESSAGE);
		myPasteAction.putValue(AbstractAction.NAME,
				KMADEConstant.PASTE_ACTION_MESSAGE);
		myPasteAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PASTE_ACTION_MESSAGE);
		myRemoveAction.putValue(AbstractAction.NAME,
				KMADEConstant.DELETE_CELL_ACTION_MESSAGE);
		myRemoveAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.DELETE_CELL_ACTION_MESSAGE);
		mySaveAction.putValue(AbstractAction.NAME,
				KMADEConstant.SAVE_PROJECT_ACTION_MESSAGE);
		mySaveAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SAVE_PROJECT_ACTION_MESSAGE);
		mySaveAsAction.putValue(AbstractAction.NAME,
				KMADEConstant.SAVE_PROJECT_AS_ACTION_MESSAGE);
		mySaveAsAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SAVE_PROJECT_AS_ACTION_MESSAGE);
		myCloseAction.putValue(AbstractAction.NAME,
				KMADEConstant.CLOSE_PROJECT_ACTION_MESSAGE);
		myCloseAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CLOSE_PROJECT_ACTION_MESSAGE);
		myOverviewPrintAction.putValue(AbstractAction.NAME,
				KMADEConstant.PRINT_PREVIEW_ACTION_MESSAGE);
		myOverviewPrintAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PRINT_PREVIEW_ACTION_MESSAGE);
		myPrintAction.putValue(AbstractAction.NAME,
				KMADEConstant.PRINT_PROJECT_ACTION_MESSAGE);
		myPrintAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PRINT_PROJECT_ACTION_MESSAGE);
		myOverviewClipboardAction.putValue(AbstractAction.NAME,
				KMADEConstant.SHOW_CLIPBOARD_MESSAGE);
		myOverviewClipboardAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SHOW_CLIPBOARD_MESSAGE);
		mySetGridAction.putValue(AbstractAction.NAME,
				KMADEConstant.CHOICE_GRID_SIZE_MESSAGE);
		mySetGridAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.CHOICE_GRID_SIZE_MESSAGE);
		myOverviewWindowAction.putValue(AbstractAction.NAME,
				KMADEConstant.PREVIEW_WINDOW_ACTION_MESSAGE);
		myOverviewWindowAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PREVIEW_WINDOW_ACTION_MESSAGE);
		mySetProjectAction.putValue(AbstractAction.NAME,
				KMADEConstant.SET_EXISTING_PROJECT_SHORT_MESSAGE);
		mySetProjectAction.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.SET_EXISTING_PROJECT_LONG_MESSAGE);
		myPreferenceTool.putValue(AbstractAction.NAME,
				KMADEConstant.PREFERENCE_ACTION_MESSAGE);
		myPreferenceTool.putValue(AbstractAction.SHORT_DESCRIPTION,
				KMADEConstant.PREFERENCE_ACTION_MESSAGE);
	}
	...
	public boolean activeMenu() {
		...
		if (projectPanel.getTaskModelPanel().getMenuEditDecomposition() != null) {
			if (projectPanel.getTaskModelPanel().getMenuEditDecomposition()
					.isVisible()) {
				return true;
			}
		}
		...
		if (projectPanel.getTaskModelPanel().getMenuEditExecutant() != null) {
			if (projectPanel.getTaskModelPanel().getMenuEditExecutant()
					.isVisible()) {
				return true;
			}
		}
