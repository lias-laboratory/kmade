...
public class KMADEToolToolBar extends JPanel implements LanguageFactory {
	...
	public static final ImageIcon SHOW_GRILLE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.SHOW_GRID_IMAGE));

	public static final ImageIcon HIDE_GRILLE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.HIDE_GRID_IMAGE));

	public static final ImageIcon SHOW_RULE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.SHOW_RULE_IMAGE));

	public static final ImageIcon HIDE_RULE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.HIDE_RULE_IMAGE));

	public static final ImageIcon CHOICE_GRID_SIZE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.CHOICE_GRID_SIZE_IMAGE));
	...
	public static final ImageIcon DELETE = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.DELETE_IMAGE));
	...
	public static final ImageIcon PRINT_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.PRINT_PREVIEW_IMAGE));

	public static final ImageIcon PRINT_LAYOUT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.PRINT_LAYOUT_IMAGE));

	public static final ImageIcon NEW_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.NEW_PROJECT_IMAGE));

	public static final ImageIcon OPEN_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.OPEN_PROJECT_IMAGE));

	public static final ImageIcon CLOSE_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.CLOSE_PROJECT_IMAGE));

	public static final ImageIcon SAVE_PROJECT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.SAVE_PROJECT_IMAGE));

	public static final ImageIcon OVERVIEW_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.OVERVIEW_IMAGE));

	public static final ImageIcon CLIPBOARD_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.CLIPBOARD_IMAGE));

	public static final ImageIcon OPTIONS_PREVIEW = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.OPTIONS_IMAGE));

	public static final ImageIcon PROJECT_IMAGE_ICON = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.PROJECT_IMAGE));

	public static final ImageIcon ENTITY_LIST_IMAGE_ICON = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.ENTITIES_IMAGE));

	public static final ImageIcon OBJECT_MANAGEMENT = new ImageIcon(
			GraphicEditorAdaptator.class.getResource(KMADEConstant.OBJECT_MANAGEMENT));
	...
	public KMADEToolToolBar() {
		...
		myOverviewPrintAction = new AbstractAction(KMADEConstant.PRINT_PREVIEW_ACTION_MESSAGE,
		...
		myOverviewClipboardAction = new AbstractAction(KMADEConstant.SHOW_CLIPBOARD_MESSAGE,
		...
		myMenuBar.add(myFileMenu);
		mySetProjectAction = new AbstractAction(KMADEConstant.SET_EXISTING_PROJECT_SHORT_MESSAGE,
		...
		// Liste des entités
		entityListAction = new AbstractAction(KMADEConstant.ENTITY_LIST_ACTION_MESSAGE,
		...
		// Load Items
		myLoadItemsAction = new AbstractAction(KMADEConstant.OPEN_ITEMS_FILE, OPEN_PROJECT) {
			private static final long serialVersionUID = 838662422873173261L;
		...
		myLoadItemsAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.OPEN_PROJECT_ACTION_MESSAGE);
		...
		mySaveItemsAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.SAVE_OBJECT_ACTION_MESSAGE);
		myFileMenu.add(mySaveItemsAction);

		// Save objects as
		this.mySaveItemsAsAction = new AbstractAction(KMADEConstant.SAVE_OBJECT_AS_ACTION_MESSAGE) {
		...
		mySaveItemsAsAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.SAVE_OBJECT_ACTION_MESSAGE);
		...
		// Edition Window
		this.myEditItemsAction = new AbstractAction(KMADEConstant.EDIT_OBJECTS_ACTION_MESSAGE, OBJECT_MANAGEMENT) {
		...
		myEditItemsAction.putValue(AbstractAction.SHORT_DESCRIPTION, KMADEConstant.EDIT_OBJECTS_ACTION_MESSAGE);
	...
	public JPopupMenu createPopupMenuForAdd(final Point pt) {
		...
		AbstractAction myAction = new AbstractAction(KMADEConstant.NEW_UNKNOWN_TASK_ACTION_MESSAGE,
		...
		myAction = new AbstractAction(KMADEConstant.NEW_ABSTRACT_TASK_ACTION_MESSAGE,
		...
		myAction = new AbstractAction(KMADEConstant.NEW_USER_TASK_ACTION_MESSAGE,
		...
		myAction = new AbstractAction(KMADEConstant.NEW_FEEDBACK_TASK_ACTION_MESSAGE,
		...
		myAction = new AbstractAction(KMADEConstant.NEW_INTERACTION_TASK_ACTION_MESSAGE,
