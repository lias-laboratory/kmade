...
public class KMADEPreferencesTaskPanel extends javax.swing.JPanel {
	...
	taskFontComboBox.setModel(new javax.swing.DefaultComboBoxModel(
		new String[] { KMADEConstant.ARIAL_FONT,
			KMADEConstant.TIMES_FONT, KMADEConstant.TAHOMA_FONT }));

	this.taskFontSizeComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
	...
	taskFontSizeComboBox.setModel(new javax.swing.DefaultComboBoxModel(
		new String[] { "8", "10", "12", "13", "14", "15", "16", "17",
			"18", "19" }));

	this.taskFontColorComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	taskFontColorComboBox
		.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
			KMADEConstant.COLOR_BLACK, KMADEConstant.COLOR_WHITE,
			KMADEConstant.COLOR_BLUE, KMADEConstant.COLOR_GREEN,
			KMADEConstant.COLOR_YELLOW }));

	this.taskFontStyleComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	taskFontStyleComboBox.setModel(new javax.swing.DefaultComboBoxModel(
		new String[] { KMADEConstant.STYLE_PLAIN,
			KMADEConstant.STYLE_BOLD, KMADEConstant.STYLE_ITALIC,
			KMADEConstant.STYLE_BOLD_ITALIC }));

	this.taskBackgroundColorComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	taskBackgroundColorComboBox
		.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
			KMADEConstant.COLOR_NO_COLOR, /*
						       * KMADEConstant.COLOR_RED,
						       */
			KMADEConstant.COLOR_BLUE, KMADEConstant.COLOR_GREEN,
			KMADEConstant.COLOR_YELLOW }));

	this.operatorFontComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
	...
	this.operatorFontStyleComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
	...
	operatorFontStyleComboBox
		.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
			KMADEConstant.STYLE_PLAIN, KMADEConstant.STYLE_BOLD,
			KMADEConstant.STYLE_ITALIC,
			KMADEConstant.STYLE_BOLD_ITALIC }));

	operatorFontSizeComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
	...
	this.operatorFontColorComboBox
		.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
			PreferencesAdaptator.enableApplyButton();
		    }
		});
	operatorFontColorComboBox
		.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
			KMADEConstant.COLOR_BLACK, /* KMADEConstant.COLOR_RED, */
			KMADEConstant.COLOR_BLUE, KMADEConstant.COLOR_GREEN,
			KMADEConstant.COLOR_YELLOW }));
	...
	previewPanel.add(new OverviewPane(), new GridBagConstraints(0, 0, 1, 1,
		0, 0, GridBagConstraints.CENTER, GridBagConstraints.CENTER,
	...
	public Dimension getPreferredSize() {
	    ...
	    FontMetrics fnum = myPanel
		    .getFontMetrics(KMADEConstant.TASK_NUM_FONT);
	    String num = "N:1.1.2.2";
	    String iteration = KMADEConstant.VERTEX_STATE_LETTER
		    + KMADEConstant.PREDICAT_ITERATION_VIEW_MESSAGE;
	    int maxNumOrIter = Math.max(fnum.stringWidth(num),
		    fnum.stringWidth(iteration));

	    int width = 0;
	    if (fname.stringWidth(name) < (16 + 32 + 4 + 4
		    * Math.max(num.length(), iteration.length()) + maxNumOrIter + 10)) {
		width = 16 + 32 + 4 + 4
			* Math.max(num.length(), iteration.length())
			+ maxNumOrIter + 10;
	    } else {
	...
	protected void paintStateCaract(Graphics2D f, int widthString,
	    ...
	    f.drawString(iterString, widthString, 10 + V_NUM_ITE_GAP
		    + (int) num + V_NUM_ITE_GAP + (int) iter);
	}
	...
	public void paint(Graphics gr) {
	    ...
	    this.paintStateCaract(f, width + 32 / 2 + 2, numero, iteration,
		    rnum.getHeight(), riter.getHeight());
	    ...
	    // L'opérateur
	    String operateur = Decomposition
	    ...
	    f.drawRect((int) (width - (ro.getWidth() / 2)) - 2,
		    currentHeighImage - 2, (int) ro.getWidth() + 2 * 2,
	...
	taskNomPanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.TASK_PANEL_NAME_PANEL_NAME));
	taskFontLabel.setText(KMADEConstant.TASK_PANEL_NAME_FONT_NAME_LABEL);

	taskFontStyleLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_STYLE_LABEL);

	taskFontSizeLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_SIZE_LABEL);

	taskFontColorLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_COLOR_LABEL);

	taskBackgroundColorLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_BACKGROUND_COLOR_LABEL);

	org.jdesktop.layout.GroupLayout taskNomPanelLayout = new org.jdesktop.layout.GroupLayout(
		taskNomPanel);
	taskNomPanel.setLayout(taskNomPanelLayout);
	taskNomPanelLayout
		.setHorizontalGroup(taskNomPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(taskNomPanelLayout
					...
					.add(taskNomPanelLayout
						...
						.add(taskNomPanelLayout
							.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
							.add(taskFontLabel)
							.add(taskFontStyleLabel))
						.addPreferredGap(
							org.jdesktop.layout.LayoutStyle.RELATED)
						.add(taskNomPanelLayout
							.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
							.add(taskFontStyleComboBox,
								0, 119,
								Short.MAX_VALUE)
							.add(taskFontComboBox,
								0, 119,
								Short.MAX_VALUE))
						.addPreferredGap(
							org.jdesktop.layout.LayoutStyle.RELATED)
						.add(taskNomPanelLayout
							.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
							.add(taskFontColorLabel)
							.add(taskFontSizeLabel))
						.addPreferredGap(
							org.jdesktop.layout.LayoutStyle.RELATED)
						.add(taskNomPanelLayout
							.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
							.add(taskFontColorComboBox,
								0, 123,
								Short.MAX_VALUE)
							.add(taskFontSizeComboBox,
								0, 123,
								Short.MAX_VALUE))
						.addContainerGap())
					.add(taskNomPanelLayout
						.createSequentialGroup()
						.add(taskBackgroundColorLabel)
						.addPreferredGap(
							org.jdesktop.layout.LayoutStyle.RELATED)
						.add(taskBackgroundColorComboBox,
							0, 192, Short.MAX_VALUE)
						.addContainerGap()))));
	taskNomPanelLayout
		.setVerticalGroup(taskNomPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(taskNomPanelLayout
				.createSequentialGroup()
	...
	operatorPanel
		.setBorder(javax.swing.BorderFactory
			.createTitledBorder(KMADEConstant.TASK_PANEL_DECOMPOSITION_PANEL_NAME));
	operatorFontLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_NAME_LABEL);

	operatorFontStyleLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_STYLE_LABEL);

	operatorFontSizeLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_SIZE_LABEL);

	operatorFontColorLabel
		.setText(KMADEConstant.TASK_PANEL_NAME_FONT_COLOR_LABEL);

	org.jdesktop.layout.GroupLayout operatorPanelLayout = new org.jdesktop.layout.GroupLayout(
		operatorPanel);
	operatorPanel.setLayout(operatorPanelLayout);
	operatorPanelLayout
		.setHorizontalGroup(operatorPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(operatorPanelLayout
				.createSequentialGroup()
				.addContainerGap()
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING)
					.add(operatorFontLabel)
				...
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING)
					.add(operatorFontStyleComboBox, 0, 112,
						Short.MAX_VALUE)
					.add(operatorFontComboBox, 0, 112,
						Short.MAX_VALUE))
				.addPreferredGap(
					org.jdesktop.layout.LayoutStyle.RELATED)
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING)
					.add(operatorFontColorLabel)
					.add(operatorFontSizeLabel))
				.addPreferredGap(
					org.jdesktop.layout.LayoutStyle.RELATED)
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING)
					.add(operatorFontColorComboBox, 0, 128,
						Short.MAX_VALUE)
					.add(operatorFontSizeComboBox, 0, 128,
						Short.MAX_VALUE))
				.addContainerGap()));
	operatorPanelLayout
		.setVerticalGroup(operatorPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(operatorPanelLayout
				.createSequentialGroup()
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.BASELINE)
					.add(operatorFontLabel)
					.add(operatorFontComboBox,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
					.add(operatorFontSizeLabel)
					.add(operatorFontSizeComboBox,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(
				...
				.add(operatorPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.BASELINE)
					.add(operatorFontStyleLabel)
					.add(operatorFontStyleComboBox,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
					.add(operatorFontColorLabel)
					.add(operatorFontColorComboBox,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
				.addContainerGap(
	...
	modelPanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.TASK_PANEL_MODEL_PANEL_NAME));
	modelLabel.setText(KMADEConstant.TASK_PANEL_MODEL_CHOICE_LABEL);

	saveModelJButton
		.setText(KMADEConstant.TASK_PANEL_MODEL_SAVE_BUTTON_LABEL);

	loadModelJButton
		.setText(KMADEConstant.TASK_PANEL_MODEL_LOAD_BUTTON_LABEL);

	org.jdesktop.layout.GroupLayout modelPanelLayout = new org.jdesktop.layout.GroupLayout(
		modelPanel);
	modelPanel.setLayout(modelPanelLayout);
	modelPanelLayout
		.setHorizontalGroup(modelPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(modelPanelLayout
				.createSequentialGroup()
				.addContainerGap()
				.add(modelLabel)
				.addPreferredGap(
				...
				.add(modelPanelLayout
					...
					.add(modelPanelLayout
						.createSequentialGroup()
						.add(saveModelJButton)
						.add(2, 2, 2)
						.add(loadModelJButton))
					.add(modelComboBox, 0, 305,
						Short.MAX_VALUE))
				.addContainerGap()));
	modelPanelLayout
		.setVerticalGroup(modelPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(modelPanelLayout
				.createSequentialGroup()
	...
	previewPanel
		.setBorder(javax.swing.BorderFactory
			.createTitledBorder(KMADEConstant.TASK_PANEL_PREVIEW_PANEL_NAME));
	org.jdesktop.layout.GroupLayout previewPanelLayout = new org.jdesktop.layout.GroupLayout(
		previewPanel);
	...
	org.jdesktop.layout.GroupLayout panelEditionLayout = new org.jdesktop.layout.GroupLayout(
		panelEdition);
	panelEdition.setLayout(panelEditionLayout);
	panelEditionLayout
		.setHorizontalGroup(panelEditionLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(panelEditionLayout
				.createSequentialGroup()
				.add(panelEditionLayout
					.createParallelGroup(
				...
				.add(previewPanel,
					...
					Short.MAX_VALUE)));
	panelEditionLayout
		.setVerticalGroup(panelEditionLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(previewPanel,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
	...
	optionsPanel
		.setBorder(javax.swing.BorderFactory
			.createTitledBorder(KMADEConstant.TASK_PANEL_OPTIONS_PANEL_NAME));
	actorTaskCheckBox
		.setText(KMADEConstant.TASK_PANEL_OPTIONS_ACTOR_TASK_LABEL);
	actorTaskCheckBox.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	actorTaskCheckBox.setMargin(new java.awt.Insets(0, 0, 0, 0));

	eventTaskCheckBox
		.setText(KMADEConstant.TASK_PANEL_OPTIONS_TRIGGER_EVENT_LABEL);
	eventTaskCheckBox.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	...
	optionsPanelLayout
		.setHorizontalGroup(optionsPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(optionsPanelLayout
				.createSequentialGroup()
				.addContainerGap()
				.add(optionsPanelLayout
					.createParallelGroup(
						org.jdesktop.layout.GroupLayout.LEADING)
					.add(actorTaskCheckBox)
					.add(eventTaskCheckBox))
				.addContainerGap(165, Short.MAX_VALUE)));
	optionsPanelLayout.setVerticalGroup(optionsPanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(optionsPanelLayout.createSequentialGroup()
			.add(actorTaskCheckBox).add(11, 11, 11)
			.add(eventTaskCheckBox)));
	...
	if (value == KMADEConstant.FRENCH_LANGUAGE_INFO) {
	    taskFontComboBox
		    .setSelectedItem(KMADEConstant.FRENCH_LANGUAGE_INFO);
	} else if (value == KMADEConstant.ENGLISH_LANGUAGE_INFO) {
	    taskFontComboBox
		    .setSelectedItem(KMADEConstant.ENGLISH_LANGUAGE_INFO);
	}
