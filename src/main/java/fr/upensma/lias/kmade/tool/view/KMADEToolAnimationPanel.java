 ...
 */
public class KMADEToolAnimationPanel extends JComponent implements
	ActionListener {
	...
	icon[3] = new ImageIcon(this.getClass().getResource(
		KMADEConstant.BARON_IMAGE));
	icon[4] = new ImageIcon(this.getClass().getResource(
		KMADEConstant.SCAPIN_IMAGE));
