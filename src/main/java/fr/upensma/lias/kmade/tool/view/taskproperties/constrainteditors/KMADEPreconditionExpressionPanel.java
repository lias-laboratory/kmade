...
public class KMADEPreconditionExpressionPanel extends JPanel implements LanguageFactory {
	...
	public KMADEPreconditionExpressionPanel() {
		...
		this.and.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.AND]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.AND].length() - 1));
			}
		});
		this.diff.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOT_EQUAL]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.NOT_EQUAL].length() - 1));
			}
		});
		this.equal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EQUAL]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.EQUAL].length() - 1));
			}
		});
		this.in.setEnabled(false);
		this.inf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.INF]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.INF].length() - 1));
			}
		});
		this.infEqual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.INF_EQUAL]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.INF_EQUAL].length() - 1));
			}
		});
		this.isEmpty.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EMPTY]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.EMPTY].length() - 1) + "("
						+ "  " + ")");
			}
		});
		this.isExist.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXIST]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.EXIST].length() - 1) + "("
						+ "  ,  " + ")");
			}
		});
		this.isExistAt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXISTAT]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.EXISTAT].length() - 1)
						+ "(" + "  ,  " + ")");
			}
		});
		this.length1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOMBRE]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.NOMBRE].length() - 1) + "("
						+ "  " + ")");
			}
		});
		...
		this.not.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOT]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.NOT].length() - 1) + "("
						+ "  " + ")");
			}
		});
		this.or.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.OR]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.OR].length() - 1));
			}
		});
		this.pf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.PARF]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.PARF].length() - 1));
			}
		});
		this.po.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.PARO]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.PARO].length() - 1));
			}
		});
		this.sup.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.SUP]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.SUP].length() - 1));
			}
		});
		this.supEqual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.SUP_EQUAL]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.SUP_EQUAL].length() - 1));
			}
		});
		this.ubool.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(
						PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_BOOLEAN].substring(1,
								PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_BOOLEAN].length() - 1));
			}
		});
		this.uint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator
						.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_NUMBER].substring(1,
								PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_NUMBER].length() - 1));
			}
		});
		this.ustr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator
						.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_STRING].substring(1,
								PreconditionConstants.tokenImage[PreconditionConstants.UNKNOWN_STRING].length() - 1));
			}
		});
		this.vcst.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String currentValue = ((String) vcstchoice.getSelectedItem());
				PreconditionAdaptator.addNewLiteral(TypeStructure.getLocaleTypeStructureIntoEnumere(currentValue),
						vcst.getText());
			}
		});
		...
		this.getValue2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PreconditionAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.GETVALUE]
						.substring(1, PreconditionConstants.tokenImage[PreconditionConstants.GETVALUE].length() - 1)
						+ "(" + "  ,  " + ")");
			}
		});
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel1Layout.createSequentialGroup().add(vcstchoice, 0, 85, Short.MAX_VALUE)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(vcst, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(vcst, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
				.add(vcstchoice, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE));
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(layout.createSequentialGroup().addContainerGap()
								.add(literalPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(operatorPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(functionPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(layout.createSequentialGroup().addContainerGap()
						.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(org.jdesktop.layout.GroupLayout.TRAILING, literalPanel,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
								.add(functionPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
								.add(operatorPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE))
						.addContainerGap()));
	}
