...
public class KMADEEditorActorSystemDialog extends JPropertiesEditorDialog {
    ...
    public KMADEEditorActorSystemDialog() {
        ...
        String[] columnNames = {KMADEConstant.ACTORSYSTEM_NAME_TABLE,KMADEConstant.ACTORSYSTEM_EXPERIENCE_TABLE, KMADEConstant.ACTORSYSTEM_COMPETENCE_TABLE};
   ...
   public void addNewActorSystem(String name, String experience, String competence, String oidActorSystem) {
        Object[] myNewRow = {name, Experience.getEnumereIntoLocaleExperience(experience), competence, oidActorSystem, false};
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            ...
            if (rowIndex + 1 == this.getRowCount()) {
                ...
                switch(columnIndex) {
                        ...
                        if (((String)this.getValueAt(rowIndex,columnIndex)).equals(value)) {
                       	return;
                        	...
                        	if (newOid==null) {
                            	...
                            	// si il y a eu une mise � jour de l'acteur : l'oid a changer, 
                    ...
                    case 1 : {
                        ActorSystemAdaptator.setActorSystemExperience(oidRow,Experience.getLocaleExperienceIntoEnumere(value));
                        break;
                    }
                    case 2 : {
    ...
    class MyKeyListener extends KeyAdapter {
        public void keyPressed(KeyEvent ke) {
            if (ke.getKeyCode() == KeyEvent.VK_DELETE) {
                ...
                boolean state = GraphicEditorAdaptator.removeSelectedItem("ActorSystem",r,myTableListModel.getListTableData(),KMADEEditorActorSystemDialog.this, KMADEConstant.ACTORSYSTEM_REMOVE_NAME_TITLE);
