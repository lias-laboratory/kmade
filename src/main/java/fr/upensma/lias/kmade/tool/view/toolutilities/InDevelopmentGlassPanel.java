...
public class InDevelopmentGlassPanel extends JComponent {
	...
	InDevelopmentGlassPanel myGlassPanel = new InDevelopmentGlassPanel(
		"Under Development ...", Color.GRAY);
	...
	if (!myString.equals("")) {
	    ...
	    g2d.drawString(
		    myString,
		    15,
		    (int) (((this.getBounds().height / 2) + ((heighText / 2) * scaleAlpha)) / (scaleAlpha)));
	}
    }
}
