...
public class KMADEPreferencesGeneralPanel extends javax.swing.JPanel {
	...
	public KMADEPreferencesGeneralPanel() {
		...
		this.timeSaveComboBox
				.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "5", "15", "30", "45", "60" }));
		...
		this.zoomComboBox
				.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0.10", "0.25", "0.50", "0.75", "1" }));
		...
		this.languageComboBox.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { KMADEConstant.FRENCH_LANGUAGE_INFO, KMADEConstant.ENGLISH_LANGUAGE_INFO }));
	...
	private void initComponents() {
		...
		configurationPanel.setBorder(
				javax.swing.BorderFactory.createTitledBorder(KMADEConstant.GENERAL_PANEL_CONFIGURATION_PANEL_NAME));
		...
		configurationPanelLayout.setHorizontalGroup(configurationPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(configurationPanelLayout.createSequentialGroup().add(configurationPanelLayout
						.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
								configurationPanelLayout.createSequentialGroup().addContainerGap()
										.add(configurationPanelLayout
												.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(automaticSaveCheckBox).add(forceGarbageLabel).add(zoomLabel))
										.add(9, 9, 9)
										.add(configurationPanelLayout
												.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
												.add(timeSaveComboBox, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.add(forceGarbageJButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.add(zoomComboBox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
						.add(configurationPanelLayout.createSequentialGroup().addContainerGap()
								.add(splashScreenCheckBox))
						.add(configurationPanelLayout.createSequentialGroup().addContainerGap().add(envoiBugCheckBox)))
		...
		configurationPanelLayout.setVerticalGroup(configurationPanelLayout
				...
				.add(configurationPanelLayout.createSequentialGroup()
						.add(configurationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(timeSaveComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(automaticSaveCheckBox))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(configurationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(forceGarbageJButton).add(forceGarbageLabel))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(configurationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(zoomComboBox).add(zoomLabel))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(envoiBugCheckBox)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 12, Short.MAX_VALUE)
						.add(splashScreenCheckBox).add(9, 9, 9)));

		languagePanel.setBorder(
				javax.swing.BorderFactory.createTitledBorder(KMADEConstant.GENERAL_PANEL_LANGUAGE_PANEL_NAME));
		...
		languagePanelLayout
				.setHorizontalGroup(languagePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(languagePanelLayout.createSequentialGroup().addContainerGap().add(languageLabel)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(languageComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 98,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(87, Short.MAX_VALUE)));
		languagePanelLayout
				.setVerticalGroup(languagePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		raccourcisPanel
				.setBorder(javax.swing.BorderFactory.createTitledBorder(KMADEConstant.GENERAL_PANEL_KEYS_PANEL_NAME));
		...
		raccourcisPanelLayout.setVerticalGroup(raccourcisPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 33, Short.MAX_VALUE));

		org.jdesktop.layout.GroupLayout layout = new org.jdesktop.layout.GroupLayout(this);
		this.setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(languagePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.add(configurationPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.add(raccourcisPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout
				.createSequentialGroup()
				.add(configurationPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
				.add(languagePanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
				.add(3, 3, 3).add(raccourcisPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
	}
	...
	public void setRaccourcis(String name, String value) {
		int i = 0;
		while ((!(raccourcisJTable.getValueAt(i, 1).equals(name))) && (i <= raccourcisJTable.getRowCount())) {
			i++;
		}
