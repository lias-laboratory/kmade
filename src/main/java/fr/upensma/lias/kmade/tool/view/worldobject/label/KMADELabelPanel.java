...
public class KMADELabelPanel extends JScrollPane implements LanguageFactory {
	...
	public KMADELabelPanel() {
		String[] columnNames = { KMADEConstant.LABEL_NUMERO_TITLE, KMADEConstant.LABEL_NAME_TITLE,
				KMADEConstant.LABEL_DESCRIPTION_TITLE, KMADEConstant.LABEL_COLOR_TITLE,
				KMADEConstant.LABEL_IS_VISIBLE_COLOR_TITLE, KMADEConstant.LABEL_IS_VISIBLE_TITLE };
		...
		myTitledBorder = new TitledBorder(null, KMADEConstant.LABEL_EDITOR_TITLE, TitledBorder.CENTER,
				TitledBorder.TOP);
	...
	public void addLabel(String name, String description, Color myColor, boolean colorvisible, boolean visible,
			String oid) {
	...
	class MyKeyListener extends KeyAdapter {
		public void keyPressed(KeyEvent ke) {
			if (ke.getKeyCode() == KeyEvent.VK_DELETE) {
				...
				boolean state = GraphicEditorAdaptator.removeSelectedItem("Label", r,
