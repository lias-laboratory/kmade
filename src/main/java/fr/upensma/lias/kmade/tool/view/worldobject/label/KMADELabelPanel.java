...
**********************************************************************************/
package fr.upensma.lias.kmade.tool.view.worldobject.label;
...
public class KMADELabelPanel extends JScrollPane implements LanguageFactory {
	...
	String[] columnNames = { KMADEConstant.LABEL_NUMERO_TITLE,
		KMADEConstant.LABEL_NAME_TITLE,
		KMADEConstant.LABEL_DESCRIPTION_TITLE,
		KMADEConstant.LABEL_COLOR_TITLE,
		KMADEConstant.LABEL_IS_VISIBLE_COLOR_TITLE,
		KMADEConstant.LABEL_IS_VISIBLE_TITLE };
	myTableListModel = new MyTableListModel(columnNames,
		KMADEConstant.LABEL_ADD_NEW_LABEL_TITLE);
	...
	myTitledBorder = new TitledBorder(null,
		KMADEConstant.LABEL_EDITOR_TITLE, TitledBorder.CENTER,
		TitledBorder.TOP);
	this.setBorder(myTitledBorder);
	myListTable.getMyTable().setDefaultEditor(Color.class,
		new ColorEditor());
	myListTable.getMyTable().setDefaultRenderer(Color.class,
		new ColorRenderer(true));
	myListTable.getMyTable().setDefaultRenderer(Boolean.class,
		new BooleanRenderer());
    ...
    public void addLabel(String name, String description, Color myColor,
	    boolean colorvisible, boolean visible, String oid) {
	Object[] tempo = { name, description, myColor, colorvisible, visible,
		oid, false };
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		Object[] tempo = { value, "", Color.WHITE, true, true,
			newLabelObject, false };
		myTableListModel.getListTableData().add(tempo);
		...
		case 4: {
		    LabelAdaptator
			    .setLabelColorVisible(oidRow, (Boolean) value);
		    break;
		}
		case 5: {
	...
	public void keyPressed(KeyEvent ke) {
		...
		boolean state = GraphicEditorAdaptator.removeSelectedItem(
			"Label", r, myTableListModel.getListTableData(),
			GraphicEditorAdaptator.getMainFrame(),
