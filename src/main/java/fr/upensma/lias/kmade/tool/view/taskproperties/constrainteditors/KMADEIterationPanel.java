...
public class KMADEIterationPanel extends JPanel implements LanguageFactory {
	...
	panelHaut.setBorder(BorderFactory
		.createTitledBorder(KMADEConstant.ITERATION_EDITION_MESSAGE));
	...
	panelDescription
		.setBorder(BorderFactory
			.createTitledBorder(KMADEConstant.ITERATION_TEXTUEL_EDITION_MESSAGE));
