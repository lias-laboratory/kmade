 ...
 */
public class KMADEReadWriteMachineObjectPanel extends JPanel implements
	LanguageFactory {
	...
	if (oid.equals(Oid.OID_NULL)) {
	    ...
	    Object[][] tabOrgaNotAdd = MachinePanelAdaptator
		    .getOtherParcsIntoTab(oid);
	...
	try {
	    ...
	    ExpressMachine.removeMachineInParcMachines(oidActiveMachine,
		    oidParcMachines);
	} catch (Exception e) {
