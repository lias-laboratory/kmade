 ...
 */
public class KMADEPreviewPanel extends JPanel
	...
	public class PreviewScrollPane extends JScrollPane implements MouseListener, MouseMotionListener {
		...
		public void paint(Graphics g) {
			...
			JScrollPane jscrollpane = KMADEPreviewPanel.getParentScrollPane(jgraph);
			...
			if (jscrollpane != null && jgraph != null) {
				...
				g.fillRect(0, 0, (int) ((double) dimension.width * d1), (int) ((double) dimension.height * d1));
				g.setColor(Color.WHITE);
				_fldif.setFrame((int) (rectangle.getX() * d1), (int) (rectangle.getY() * d1),
						(int) (rectangle.getWidth() * d1), (int) (rectangle.getHeight() * d1));
		...
		public void mouseDragged(MouseEvent mouseevent) {
			if (a != null) {
				...
				if (jscrollpane != null && jgraph != null) {
					...
					a = mouseevent.getPoint();
					d2 = rectangle.getX() + (d2 <= 0.0D ? 0.0D : rectangle.getWidth()) + d2;
					d3 = rectangle.getY() + (d3 <= 0.0D ? 0.0D : rectangle.getHeight()) + d3;
