 ...
 */
public class KMADETypeEnumElementTable extends JScrollPane implements
	LanguageFactory {
	...
	myTableListModel = new MyTableListModel(columnNames,
		KMADEConstant.ELEMENT_NEW_OBJECT_TABLE);
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		String newEnumElement = EnumElementAdaptator
			.addElement(TypePanelAdaptator.getEnumerationActive());
		value = EnumElementAdaptator.setElementName(newEnumElement,
			value);
		...
		if (nameRow.equals(value)) {
		    ...
		    switch (columnIndex) {
		    case 0:
			value = EnumElementAdaptator.setElementName(oidRow,
				value);
			break;
		    }
	...
	public void keyPressed(KeyEvent ke) {
		...
		boolean state = GraphicEditorAdaptator.removeSelectedItem(
			"EnumElement", r, myTableListModel.getListTableData(),
