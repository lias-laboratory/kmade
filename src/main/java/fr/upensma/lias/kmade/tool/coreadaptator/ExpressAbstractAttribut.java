...
public class ExpressAbstractAttribut {
    public static ArrayList<AttributAbstrait> getAbstractAttributs(
	    ObjetAbstrait oa) {
	return oa.getInverseAttributsAbs();
    }

    public static String getOidWithAbstractAttributName(String n,
	    String oidObjAbs) {
	ObjetAbstrait objAbs = (ObjetAbstrait) InterfaceExpressJava
		.prendre(new Oid(oidObjAbs));
	...
	AttributAbstrait attrib = (AttributAbstrait) InterfaceExpressJava
		.prendre(new Oid(oidAttrAbs));
	...
	AttributAbstrait m = (AttributAbstrait) InterfaceExpressJava
		.prendre(new Oid(oid));
	m.delete();
    }
	...
	if (oidNameType.equals(Oid.OID_NULL)) {
	    ...
	    TypeAbs a = (TypeAbs) InterfaceExpressJava.prendre(new Oid(
		    oidNameType));
    ...
    public static AttributAbstrait getRefAbstractAttributFromName(
	    Groupe rGroup, String name) {
