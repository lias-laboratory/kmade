...
public class KMADEToolAbout extends JDialog implements LanguageFactory {
	...
	public KMADEToolAbout(Frame owner) {
		...
		panel_info.add(KMADEToolUtilities.getLabelCenter(KMADEToolConstant.TOOL_NAME + " "
				+ KMADEConstant.VERSION_MESSAGE + " " + KMADEToolConstant.VERSION_VALUE));
		panel_info.add(KMADEToolUtilities.getLabelCenter("2005 - 2015"));
		panel_info.add(KMADEToolUtilities.getLabelCenter("INRIA Rocquencourt - Projet MErLIn - LIAS / ISAE-ENSMA"));
	...
	public void notifLocalisationModification() {
		...
		participants.append(" - Mickael Baron (baron@ensma.fr)\n\n");
