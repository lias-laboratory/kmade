...
public class KMADEEnhancedTaskEditor extends JFrame implements ActionListener, KeyListener, MouseListener, LanguageFactory {
	...
	this.declenchementField.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		TaskPropertiesEnhancedEditorAdaptator
			.setDeclenchement((String) declenchementField
				.getSelectedItem());
	    }
	});
	...
	this.interruptibleInterruptibilite
	...
	this.nointerruptibleInterruptibilite
		.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
			TaskPropertiesEnhancedEditorAdaptator
				.setNoInterruptibilite();
		    }
		});
	...
	org.jdesktop.layout.GroupLayout panelWestLayout = new org.jdesktop.layout.GroupLayout(
		panelWest);
	panelWest.setLayout(panelWestLayout);
	panelWestLayout.setHorizontalGroup(panelWestLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(gaucheLabel));
	panelWestLayout.setVerticalGroup(panelWestLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(gaucheLabel,
		org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 758,
		Short.MAX_VALUE));
	...
	preconditionPanel.setBorder(BorderFactory.createTitledBorder(
		new LineBorder(UIManager.getDefaults().getColor(
			"activeCaptionBorder"), 2, true),
		KMADEConstant.EXECUTION_CONDITION_TITLE_NAME));
	jScrollPane7.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.PRECONDITION_LABEL_VALUE));
	...
	jScrollPane3.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.ITERATION_LABEL_VALUE));
	...
	preconditionPanelLayout.setHorizontalGroup(preconditionPanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(jScrollPane3,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 427,
			Short.MAX_VALUE)
		.add(jScrollPane7,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 427,
			Short.MAX_VALUE));
	preconditionPanelLayout
		.setVerticalGroup(preconditionPanelLayout
			.createParallelGroup(
	...
	jScrollPane4
		.setBorder(javax.swing.BorderFactory.createTitledBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager
				.getDefaults().getColor("activeCaptionBorder"),
				2, true), KMADEConstant.OBJECT_LIST_TITLE_NAME));
	...
	caracteristiquePanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager
				.getDefaults().getColor("activeCaptionBorder"),
				2, true),
	...
	unkImportance.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	lowImportance.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	lowImportance.setMargin(new java.awt.Insets(0, 0, 0, 0));

	ImportanceGroup.add(middleImportance);
	middleImportance.setFont(new java.awt.Font("Microsoft Sans Serif", 0,
		10));
	middleImportance.setText(Importance
		.getEnumereIntoLocaleImportance("AVERAGE"));
	middleImportance.setBorder(javax.swing.BorderFactory.createEmptyBorder(
		0, 0, 0, 0));
	...
	highImportance.setText(Importance
		.getEnumereIntoLocaleImportance("HIGH"));
	highImportance.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	unkFrequence.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	highFrequence.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	highFrequence.setMargin(new java.awt.Insets(0, 0, 0, 0));

	frequencyGroup.add(averageFrequence);
	averageFrequence.setFont(new java.awt.Font("Microsoft Sans Serif", 0,
		10));
	averageFrequence.setText(Frequence
		.getEnumereIntoLocaleFrequence("AVERAGE"));
	averageFrequence.setBorder(javax.swing.BorderFactory.createEmptyBorder(
		0, 0, 0, 0));
	...
	lowFrequence.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	jScrollPane5.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.TASK_OBSERVATION_TITLE));
	...
	caracteristiquePanelLayout
		.setHorizontalGroup(caracteristiquePanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				caracteristiquePanelLayout
					...
					.add(jPanel1,
						...
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)));
	caracteristiquePanelLayout
		.setVerticalGroup(caracteristiquePanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.TRAILING,
				caracteristiquePanelLayout
	...
	ordonnancementPanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager
				.getDefaults().getColor("activeCaptionBorder"),
				2, true),
	...
	optionnelleNecessite.setFont(new java.awt.Font("Microsoft Sans Serif",
		0, 10));
	optionnelleNecessite.setText(KMADEConstant.OPTIONAL_NECESSITE_VALUE);
	optionnelleNecessite.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	optionnelleNecessite.setMargin(new java.awt.Insets(0, 0, 0, 0));

	necessityGroup.add(obligatoireNecessite);
	obligatoireNecessite.setFont(new java.awt.Font("Microsoft Sans Serif",
		0, 10));
	obligatoireNecessite.setText(KMADEConstant.NO_OPTIONAL_NECESSITE_VALUE);
	obligatoireNecessite.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	obligatoireNecessite.setMargin(new java.awt.Insets(0, 0, 0, 0));

	interruptibilityGroup.add(interruptibleInterruptibilite);
	interruptibleInterruptibilite.setFont(new java.awt.Font(
		"Microsoft Sans Serif", 0, 10));
	interruptibleInterruptibilite
		.setText(KMADEConstant.INTERRUPTIBLE_VALUE);
	interruptibleInterruptibilite.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	interruptibleInterruptibilite
		.setMargin(new java.awt.Insets(0, 0, 0, 0));

	interruptibilityGroup.add(nointerruptibleInterruptibilite);
	nointerruptibleInterruptibilite.setFont(new java.awt.Font(
		"Microsoft Sans Serif", 0, 10));
	nointerruptibleInterruptibilite
		.setText(KMADEConstant.NO_INTERRUPTIBLE_VALUE);
	nointerruptibleInterruptibilite.setBorder(javax.swing.BorderFactory
		.createEmptyBorder(0, 0, 0, 0));
	nointerruptibleInterruptibilite.setMargin(new java.awt.Insets(0, 0, 0,
		0));
	...
	unkOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("UNK"));
	unkOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	enaOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("SEQ"));
	enaOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	concOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("PAR"));
	concOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	leafOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("LEAF"));
	leafOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
		0, 0, 0));
	...
	choiceOperateur
		.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 10));
	choiceOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("ALT"));
	choiceOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(
		0, 0, 0, 0));
	...
	oiOperateur.setText(Decomposition
		.getEnumereIntoLocaleDecomposition("ENT"));
	oiOperateur.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
		0, 0));
	...
	ordonnancementPanelLayout
		.setHorizontalGroup(ordonnancementPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				ordonnancementPanelLayout
					...
					.addContainerGap()));
	ordonnancementPanelLayout
		.setVerticalGroup(ordonnancementPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				ordonnancementPanelLayout
	...
	jScrollPane1.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.EFFETSDEBORD_LABEL_VALUE));
	...
	jScrollPane2.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.EVENT_NAME_TITLE));
	...
	effetsdebordPanelLayout.setHorizontalGroup(effetsdebordPanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(jScrollPane2,
	...
	effetsdebordPanelLayout
		.setVerticalGroup(effetsdebordPanelLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				effetsdebordPanelLayout
	...
	acteurPanel
		.setBorder(javax.swing.BorderFactory.createTitledBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager
				.getDefaults().getColor("activeCaptionBorder"),
				2, true), KMADEConstant.UTILISATEUR_LABEL_NAME));
	acteurSystemePanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager
				.getDefaults().getColor("activeCaptionBorder"),
				2, true), KMADEConstant.MATERIEL_LABEL_NAME));
	...
	org.jdesktop.layout.GroupLayout acteurPanelLayout = new org.jdesktop.layout.GroupLayout(
		acteurPanel);
	acteurPanel.setLayout(acteurPanelLayout);
	acteurPanelLayout.setHorizontalGroup(acteurPanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane6,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 664,
			Short.MAX_VALUE));
	acteurPanelLayout.setVerticalGroup(acteurPanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(jScrollPane6,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 30,
			Short.MAX_VALUE));
	...
	acteurSystemePanelLayout.setHorizontalGroup(acteurSystemePanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane16,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 664,
			Short.MAX_VALUE));
	acteurSystemePanelLayout.setVerticalGroup(acteurSystemePanelLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(jScrollPane16,
			org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 30,
			Short.MAX_VALUE));

	org.jdesktop.layout.GroupLayout panelCenterLayout = new org.jdesktop.layout.GroupLayout(
		panelCenter);
	panelCenter.setLayout(panelCenterLayout);
	panelCenterLayout
		.setHorizontalGroup(panelCenterLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				panelCenterLayout
					...
					.add(2, 2, 2)));
	panelCenterLayout
		.setVerticalGroup(panelCenterLayout
			.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING)
			.add(org.jdesktop.layout.GroupLayout.LEADING,
				panelCenterLayout
					...
					.add(panelCenterLayout
						...
						.add(org.jdesktop.layout.GroupLayout.LEADING,
							ordonnancementPanel))
					.add(2, 2, 2).add(acteurPanel)
					.add(2, 2, 2).add(acteurSystemePanel)
					.add(2, 2, 2)));
	jScrollPane8.setViewportView(panelCenter);

	panelDuCentre.add(jScrollPane8, java.awt.BorderLayout.CENTER);

	org.jdesktop.layout.GroupLayout panelNorthLayout = new org.jdesktop.layout.GroupLayout(
		panelNorth);
	panelNorth.setLayout(panelNorthLayout);
	panelNorthLayout.setHorizontalGroup(panelNorthLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(hautLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
			700, Short.MAX_VALUE));
	panelNorthLayout.setVerticalGroup(panelNorthLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(hautLabel));
	panelDuCentre.add(panelNorth, java.awt.BorderLayout.NORTH);

	org.jdesktop.layout.GroupLayout panelEastLayout = new org.jdesktop.layout.GroupLayout(
		panelEast);
	panelEast.setLayout(panelEastLayout);
	panelEastLayout.setHorizontalGroup(panelEastLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(droiteLabel));
	panelEastLayout.setVerticalGroup(panelEastLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(droiteLabel,
		org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 758,
		Short.MAX_VALUE));
	panelDuCentre.add(panelEast, java.awt.BorderLayout.EAST);

	org.jdesktop.layout.GroupLayout panelSouthLayout = new org.jdesktop.layout.GroupLayout(
		panelSouth);
	panelSouth.setLayout(panelSouthLayout);
	panelSouthLayout.setHorizontalGroup(panelSouthLayout
		.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		.add(basLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
			700, Short.MAX_VALUE));
	panelSouthLayout.setVerticalGroup(panelSouthLayout.createParallelGroup(
		org.jdesktop.layout.GroupLayout.LEADING).add(basLabel));
	...
	if ((e.getSource() == acteurTable)
		|| (e.getSource() == acteurTable.getTableHeader())) {
	    ActorAdaptator.editedFromEnhancedFrame();
	    TaskPropertiesEnhancedEditorAdaptator.setActeur();
	}
	if ((e.getSource() == acteurSystemeTable)
		|| (e.getSource() == acteurSystemeTable.getTableHeader())) {
