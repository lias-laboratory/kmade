...
import fr.upensma.lias.kmade.tool.viewadaptator.ActorAdaptator;
import fr.upensma.lias.kmade.tool.viewadaptator.ActorSystemAdaptator;
 ...
 */
public class KMADEEnhancedTaskEditor extends JFrame
		implements ActionListener, KeyListener, MouseListener, LanguageFactory {
	...
	private int stateAnimation = 0; // 0 : rien; 1 : autre tache; 2 : tache
	// courante
	...
	public void displayTaskProperties(String numero, String tacheMere, String name, String but, String feed,
			String duree, String obs, Executor exec, Modality mod, Frequence freq, String compFreq, Importance imp,
			String events, boolean facultatif, boolean interruptible, String[] allevents, String dec,
			ArrayList<String[]> actRef, ArrayList<String[]> actRefSys, String prec, String post,
			Decomposition decomposition, String it) {
	...
	class MyGlassPane extends JComponent {
		...
		protected void paintComponent(Graphics g) {
			...
			Paint p = new GradientPaint(0.0F, 0.0F, vStartColor, 0.0F, h, vEndColor);
			bg2d.setPaint(p);
	...
	private void initComponents() {
		...
		panelWestLayout.setHorizontalGroup(
				panelWestLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(gaucheLabel));
		panelWestLayout.setVerticalGroup(panelWestLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		preconditionPanel.setBorder(BorderFactory.createTitledBorder(
				new LineBorder(UIManager.getDefaults().getColor("activeCaptionBorder"), 2, true),
				KMADEConstant.EXECUTION_CONDITION_TITLE_NAME));
		...
		org.jdesktop.layout.GroupLayout preconditionPanelLayout = new org.jdesktop.layout.GroupLayout(
				preconditionPanel);
		preconditionPanel.setLayout(preconditionPanelLayout);
		preconditionPanelLayout
				.setHorizontalGroup(preconditionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		preconditionPanelLayout.setVerticalGroup(
				preconditionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
						org.jdesktop.layout.GroupLayout.LEADING,
						preconditionPanelLayout.createSequentialGroup()
								.add(jScrollPane7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 69,
		...
		jScrollPane4
				.setBorder(javax.swing.BorderFactory.createTitledBorder(
						new javax.swing.border.LineBorder(
								javax.swing.UIManager.getDefaults().getColor("activeCaptionBorder"), 2, true),
						KMADEConstant.OBJECT_LIST_TITLE_NAME));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup()
						.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(modaliteLabel).add(executantLabel))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(smModalite)
								.add(cogModalite).add(userExecutant).add(sysExecutant).add(intExecutant)
								.add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup()
										.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(unkModalite).add(unkExecutant).add(absExecutant))
										.add(16, 16, 16)))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(valeurFrequenceLabel).add(frequenceLabel).add(ImportanceLabel))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(highImportance).add(middleImportance).add(lowImportance)
								.add(unkImportance, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.add(unkFrequence, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.add(highFrequence).add(averageFrequence).add(lowFrequence).add(valeurFrequenceField,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
						.addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup().add(jPanel1Layout
						.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup()
								.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(modaliteLabel).add(unkModalite))
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(smModalite)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(cogModalite)
								.add(45, 45, 45)
								.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
										.add(unkExecutant, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 14,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
										.add(executantLabel))
								.add(6, 6, 6).add(userExecutant)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(sysExecutant)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(intExecutant)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(absExecutant))
						.add(org.jdesktop.layout.GroupLayout.LEADING,
								jPanel1Layout.createSequentialGroup()
										.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
												.add(ImportanceLabel).add(unkImportance))
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(lowImportance)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(middleImportance)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(highImportance)
										.add(26, 26, 26)
										.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
												.add(frequenceLabel).add(unkFrequence))
										.add(6, 6, 6).add(highFrequence)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(averageFrequence)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(lowFrequence)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
										.add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
												.add(valeurFrequenceLabel).add(valeurFrequenceField,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		...
		org.jdesktop.layout.GroupLayout caracteristiquePanelLayout = new org.jdesktop.layout.GroupLayout(
				caracteristiquePanel);
		caracteristiquePanel.setLayout(caracteristiquePanelLayout);
		caracteristiquePanelLayout.setHorizontalGroup(caracteristiquePanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, caracteristiquePanelLayout.createSequentialGroup()
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								...
								.add(org.jdesktop.layout.GroupLayout.LEADING,
										caracteristiquePanelLayout.createSequentialGroup()
												.add(caracteristiquePanelLayout
														.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
														.add(feedbackLabel).add(purposeLabel).add(dureeLabel)
														.add(numLabel).add(nameLabel))
												.add(10, 10, 10)
												.add(caracteristiquePanelLayout
														.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
														.add(feedbackField,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 302,
																Short.MAX_VALUE)
														.add(purposeField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																302, Short.MAX_VALUE)
														.add(dureeField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																302, Short.MAX_VALUE)
														.add(numField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																302, Short.MAX_VALUE)
														.add(org.jdesktop.layout.GroupLayout.TRAILING, nameField,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 302,
																Short.MAX_VALUE))))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(jPanel1,
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)));
		caracteristiquePanelLayout.setVerticalGroup(caracteristiquePanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.TRAILING, caracteristiquePanelLayout.createSequentialGroup()
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(nameLabel).add(nameField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(numLabel).add(numField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(dureeLabel).add(dureeField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(purposeLabel).add(purposeField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(caracteristiquePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(feedbackLabel).add(feedbackField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(jScrollPane5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))
				.add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 209,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE));
		...
		org.jdesktop.layout.GroupLayout ordonnancementPanelLayout = new org.jdesktop.layout.GroupLayout(
				ordonnancementPanel);
		ordonnancementPanel.setLayout(ordonnancementPanelLayout);
		ordonnancementPanelLayout.setHorizontalGroup(ordonnancementPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, ordonnancementPanelLayout.createSequentialGroup()
						.add(ordonnancementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(org.jdesktop.layout.GroupLayout.LEADING,
										ordonnancementPanelLayout.createSequentialGroup().add(declenchementLabel)
												.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
												.add(declenchementField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
														267, Short.MAX_VALUE)
												.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED))
								.add(org.jdesktop.layout.GroupLayout.LEADING, ordonnancementPanelLayout
										.createSequentialGroup().add(operateurLabel)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
										.add(ordonnancementPanelLayout
												.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(org.jdesktop.layout.GroupLayout.LEADING, ordonnancementPanelLayout
														...
														.add(ordonnancementPanelLayout
																...
																.add(enaOperateur).add(oiOperateur))
														.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
														.add(ordonnancementPanelLayout
																.createParallelGroup(
																		org.jdesktop.layout.GroupLayout.LEADING)
																...
																.add(optionnelleNecessite).add(obligatoireNecessite)))
												.add(concOperateur))))
						.addContainerGap()));
		ordonnancementPanelLayout.setVerticalGroup(ordonnancementPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, ordonnancementPanelLayout.createSequentialGroup()
						.add(ordonnancementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(declenchementLabel).add(declenchementField,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 22,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(ordonnancementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(operateurLabel).add(unkOperateur)
								.add(NecessiteLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 16,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(optionnelleNecessite))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(ordonnancementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(enaOperateur).add(obligatoireNecessite))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(concOperateur)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(ordonnancementPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(org.jdesktop.layout.GroupLayout.LEADING,
										ordonnancementPanelLayout.createSequentialGroup().add(13, 13, 13)
												.add(ordonnancementPanelLayout
														.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
														.add(InterruptibiliteLabel).add(interruptibleInterruptibilite))
												.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
												.add(nointerruptibleInterruptibilite))
								.add(org.jdesktop.layout.GroupLayout.LEADING, ordonnancementPanelLayout
										.createSequentialGroup().add(choiceOperateur)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(leafOperateur)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(oiOperateur)))
		...
		effetsdebordPanel
				.setBorder(javax.swing.BorderFactory.createTitledBorder(
						new javax.swing.border.LineBorder(
								javax.swing.UIManager.getDefaults().getColor("activeCaptionBorder"), 2, true),
						KMADEConstant.EFFETSDEBORD_TITLE_NAME));
		...
		org.jdesktop.layout.GroupLayout effetsdebordPanelLayout = new org.jdesktop.layout.GroupLayout(
				effetsdebordPanel);
		effetsdebordPanel.setLayout(effetsdebordPanelLayout);
		effetsdebordPanelLayout
				.setHorizontalGroup(effetsdebordPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		effetsdebordPanelLayout.setVerticalGroup(
				effetsdebordPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
						org.jdesktop.layout.GroupLayout.LEADING,
						effetsdebordPanelLayout.createSequentialGroup()
								.add(jScrollPane2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 70,
										org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
		...
		acteurPanelLayout
				.setHorizontalGroup(acteurPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
						org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane6,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 664, Short.MAX_VALUE));
		acteurPanelLayout
				.setVerticalGroup(acteurPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(jScrollPane6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE));

		org.jdesktop.layout.GroupLayout acteurSystemePanelLayout = new org.jdesktop.layout.GroupLayout(
				acteurSystemePanel);
		acteurSystemePanel.setLayout(acteurSystemePanelLayout);
		acteurSystemePanelLayout.setHorizontalGroup(
				acteurSystemePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
						org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane16,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 664, Short.MAX_VALUE));
		acteurSystemePanelLayout
				.setVerticalGroup(acteurSystemePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		panelCenterLayout.setHorizontalGroup(panelCenterLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, panelCenterLayout.createSequentialGroup().add(2, 2, 2)
						.add(panelCenterLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(org.jdesktop.layout.GroupLayout.LEADING,
										panelCenterLayout.createSequentialGroup()
												.add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 231,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								...
								.add(org.jdesktop.layout.GroupLayout.LEADING, panelCenterLayout.createSequentialGroup()
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
										.add(panelCenterLayout
												.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												.add(acteurPanel).add(acteurSystemePanel)
												.add(org.jdesktop.layout.GroupLayout.LEADING, panelCenterLayout
														.createSequentialGroup()
														.add(ordonnancementPanel,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
																org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						...
						.add(2, 2, 2)));
		panelCenterLayout.setVerticalGroup(panelCenterLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.LEADING, panelCenterLayout.createSequentialGroup()
						.add(panelCenterLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
								.add(preconditionPanel).add(org.jdesktop.layout.GroupLayout.LEADING, jScrollPane4))
						.add(2, 2, 2)
						.add(caracteristiquePanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.add(2, 2, 2)
						.add(panelCenterLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
						...
						.add(2, 2, 2).add(acteurPanel).add(2, 2, 2).add(acteurSystemePanel).add(2, 2, 2)));
		...
		panelNorthLayout
				.setHorizontalGroup(panelNorthLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(hautLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE));
		panelNorthLayout.setVerticalGroup(
				panelNorthLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(hautLabel));
		...
		panelEastLayout.setHorizontalGroup(
				panelEastLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(droiteLabel));
		panelEastLayout.setVerticalGroup(panelEastLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
		...
		panelSouthLayout
				.setHorizontalGroup(panelSouthLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(basLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE));
		panelSouthLayout.setVerticalGroup(
				panelSouthLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(basLabel));
