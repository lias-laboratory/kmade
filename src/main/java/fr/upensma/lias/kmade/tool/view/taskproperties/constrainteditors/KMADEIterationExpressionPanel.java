 ...
 */
public class KMADEIterationExpressionPanel extends JPanel implements
	LanguageFactory {
	...
	this.not.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOT]
			.substring(
				1,
	...
	this.while1.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		IterationAdaptator.setNewToken(IterationConstants.tokenImage[IterationConstants.WHILE]
			.substring(
				1,
	...
	this.notWhile2.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
		IterationAdaptator.setNewToken(IterationConstants.tokenImage[IterationConstants.NOTWHILE]
			.substring(
				1,
	...
	jPanel1Layout.setVerticalGroup(jPanel1Layout
		...
		.add(vcst, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 23,
			Short.MAX_VALUE)
	...
	iteratorPanel.setBorder(javax.swing.BorderFactory
		.createTitledBorder(KMADEConstant.ITERATORS_TITLE_MESSAGE));
