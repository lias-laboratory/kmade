...
public class KMADEIterationExpressionPanel extends JPanel implements LanguageFactory {
	...
	public KMADEIterationExpressionPanel() {
		...
		this.diff.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOT_EQUAL]
		...
		this.equal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EQUAL]
		...
		this.infEqual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.INF_EQUAL]
		...
		this.isEmpty.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EMPTY]
		...
		this.isExist.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXIST]
		...
		this.isExistAt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.EXISTAT]
		...
		this.length1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOMBRE]
		...
		this.not.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.NOT].substring(1,
						PreconditionConstants.tokenImage[PreconditionConstants.NOT].length() - 1) + "(" + "  " + ")");
			}
		});
		this.or.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.OR].substring(1,
						PreconditionConstants.tokenImage[PreconditionConstants.OR].length() - 1));
			}
		});
		this.pf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.PARF].substring(1,
						PreconditionConstants.tokenImage[PreconditionConstants.PARF].length() - 1));
			}
		});
		this.po.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.PARO].substring(1,
						PreconditionConstants.tokenImage[PreconditionConstants.PARO].length() - 1));
			}
		});
		this.sup.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.SUP].substring(1,
						PreconditionConstants.tokenImage[PreconditionConstants.SUP].length() - 1));
			}
		});
		this.supEqual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.SUP_EQUAL]
		...
		this.ubool.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(
		...
		this.vcst.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				IterationAdaptator.addNewLiteral(TypeStructure.getLocaleTypeStructureIntoEnumere(currentValue),
						vcst.getText());
			}
		});
		...
		this.while1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(IterationConstants.tokenImage[IterationConstants.WHILE].substring(1,
						IterationConstants.tokenImage[IterationConstants.WHILE].length() - 1) + "(" + "  " + ")");
			}
		});

		this.notWhile2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(IterationConstants.tokenImage[IterationConstants.NOTWHILE].substring(1,
						IterationConstants.tokenImage[IterationConstants.NOTWHILE].length() - 1) + "(" + "  " + ")");
			}
		});

		this.getValue2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IterationAdaptator.setNewToken(PreconditionConstants.tokenImage[PreconditionConstants.GETVALUE]
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel1Layout.createSequentialGroup().add(vcstchoice, 0, 69, Short.MAX_VALUE)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout
				...
				.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(layout.createSequentialGroup()
								...
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
								.add(operatorPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		...
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
				...
				layout.createSequentialGroup().addContainerGap()
						.add(iteratorPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
