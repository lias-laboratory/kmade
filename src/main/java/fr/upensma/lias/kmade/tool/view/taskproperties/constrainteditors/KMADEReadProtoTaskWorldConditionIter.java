 ...
 */
public class KMADEReadProtoTaskWorldConditionIter extends JScrollPane implements LanguageFactory {
	...
	public KMADEReadProtoTaskWorldConditionIter() {
		modele = new myModel();
			...
			public void keyTyped(KeyEvent ke) {
				...
				if (ke.getKeyChar() == KeyEvent.VK_DELETE || ke.getKeyChar() == KeyEvent.VK_ENTER) {
					...
					for (int i = 0; i < r.length; i++) {
						...
						ConditionAdaptator.setIterCondition(oidConditions);
						// TODO
						GraphicEditorAdaptator.getPanelProp().getEditorPrePostIterDialog().getAllIterationPanel()
	...
	public void setOrganizationAddNameBorder(String name) {
		this.setBorder(new TitledBorder(null, KMADEConstant.CONDITION_WORLD_TITLE + " : " + name, TitledBorder.CENTER,
