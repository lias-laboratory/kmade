 ...
 */
public class KMADEReadWriteIndividuObjectPanel extends JPanel implements
	LanguageFactory {
	...
	if (oid.equals(Oid.OID_NULL)) {
	    ...
	    Object[][] tabOrgaAdd = IndividuPanelAdaptator
		    .getOrganizationIntoTab(oid);
	    ...
	    Object[][] tabOrgaNotAdd = IndividuPanelAdaptator
		    .getOtherOrganizationIntoTab(oid);
	...
	try {
	    ...
	    ExpressIndividu.addIndividuInOrganisation(oidActiveIndividu,
		    oidOrganization);
	} catch (Exception e) {
	...
	try {
	    ...
	    ExpressIndividu.removeIndividuInOrganisation(oidActiveIndividu,
		    oidOrganization);
	} catch (Exception e) {
