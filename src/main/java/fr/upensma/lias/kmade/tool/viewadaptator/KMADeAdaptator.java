...
public final class KMADeAdaptator {
	...
	public static void openSimulationDialog() {
		// Avant d'ouvrir le module simulation il faut v�rifier s'il n'existe pas d'erreur
		// /!\ Probl�me la mise � jour des valeurs ne se fait que si la boite de dialogue de coh�rence a �t� ouverte
		...
		if (erreur != 0) {
			...
			JOptionPane.showMessageDialog(GraphicEditorAdaptator.getMainFrame(),message, titre,JOptionPane.WARNING_MESSAGE, new ImageIcon(GraphicEditorAdaptator.class.getResource(KMADEConstant.INFO_DIALOG_IMAGE)));
	...
	public static void loadProjectXML() {       
		...
		if (myCurrentFile != null) {
			...
			GraphicEditorAdaptator.getMainFrame().getProgressBarDialog().readKMADModelFromXMLFile();
		} 
		updateThread = true;   
	}
	...
	/**
	 * Fermetture de l'application. A v�rifier si un projet est en cours de le sauvegarder.
	 */
	...
	public static void showHistoryDialog() {
		GraphicEditorAdaptator.getMainFrame().getInfoHistoryDialog().showInfoAbout(KMADEConstant.HISTORY_TITLE_NAME,KMADEConstant.HISTORY_KMADE_HTML);     
	}

	public static void showInfoDebugDialog() {
		GraphicEditorAdaptator.getMainFrame().getInfoDebugDialog().showInfoAbout(KMADEConstant.INFO_DEBUG_TITLE_NAME,KMADEConstant.DEBUG_KMADE_HTML);		
	}

	public static void showHelpModelDialog() {
		GraphicEditorAdaptator.getMainFrame().getInfoNMDADialog().showInfoAbout(KMADEConstant.HELP_KMAD_TITLE_NAME,KMADEConstant.HELP_KMAD_HTML);
	}

	public static void showHelpToolInfoDebugDialog() {
		GraphicEditorAdaptator.getMainFrame().getInfoHistoryDialog().showInfoAbout(KMADEConstant.HELP_KMADE_TITLE_NAME,KMADEConstant.HELP_KMADE_HTML);
	}
	...
	public static void deleteAction() {
		// Avant de supprimer une t?che ou un lien, v?rifions si nous sommes bien dans l'?diteur
		// de t?ches.
	...
	public static void showClipBoardOverView() {
		GraphicEditorAdaptator.getMainFrame().getClipBoardDialog().setVisible(!GraphicEditorAdaptator.getMainFrame().getClipBoardDialog().isVisible());
	}
