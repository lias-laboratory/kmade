...
public final class TaskPropertiesAdaptator {
	...
	public static void updatePurposeRealTime(String p) {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setPurposeRealTime(p);
	}

	public static void updateObservationRealTime(String p) {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setObservationRealTime(p);
	}
	...
	public static void setUnknownExecutant() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setExecutant(Executor.INCONNU);
	}

	public static void setUserExecutant() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setExecutant(Executor.USER);
	}

	public static void setSystemExecutant() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setExecutant(Executor.SYS);
	}

	public static void setInteractifExecutant() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setExecutant(Executor.INT);
	}

	public static void setAbstractExecutant() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setExecutant(Executor.ABS);
	}

	public static void setUnknownModalite() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setModalite(Modality.INCONNU.getValue());
	}

	public static void setSensoriMotriceModalite() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setModalite(Modality.SENS.getValue());
	}

	public static void setCognitiveModalite() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setModalite(Modality.COGN.getValue());
	}
	...
	public static void setSelectedTaskAttributes() {
		...
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().displayTaskProperties(tache.getNumber(),
				...
				tache.getEventsName(), tache.getFacultatif(), tache.isInterruptible(), tache.getRaisingEventName(),
	...
	/**
	 * Cette méthode est utilisée pour mettre a jour certaines valeurs suite � une
	 * modification des objets du monde. Utilisateur/Evenement
	 */
	public static void updateTaskPropertiesPanel() {
		...
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().updateTaskPropertiesPanel(newTabEvent,
				GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getEventsName(),
				GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getActors(),
				GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getActorSystem(), newLabelArray);
	}
	 ...
	 * ExpressTask.setFeedbackTask (GraphicEditorAdaptator.getSelectedExpressTask(),
	 * res); }
	 */
	...
	public static void setPreconditionInModel() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache()
				.setPreconditionInModel(GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getPreExpression());
	}

	public static void setEffetsDeBordInModel() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache().setEffetsDeBordInModel(
				GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getEffetsDeBordExpression());
	}

	public static void setIterationInModel() {
		KMADEMainFrame.getProjectPanel().getPanelProprieteTache()
				.setIterationInModel(GraphicEditorAdaptator.getSelectedGraphicTask().getTask().getIterExpression());
	}
}
