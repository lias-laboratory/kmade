 ...
 */
public class KMADEReadIndividuInOrganisation extends JScrollPane implements
	LanguageFactory {
	...
	table.addKeyListener(new KeyListener() {
		...
		if (ke.getKeyChar() == KeyEvent.VK_DELETE
			...
			KMADEMainFrame.getProjectPanel().getOrganisationPanel()
				.removeIndividuOfOrganization(oidIndi);
		    }
		    KMADEMainFrame.getProjectPanel().getOrganisationPanel()
	...
	this.setBorder(new TitledBorder(null,
		KMADEConstant.ORGANIZATION_MEMBERS_TABLE + " : " + name,
