...
public class ExpressIndividu{
	...
	/**
	 * Cette m�thode retourne les organisations auquel appartient l'individu ayant pour oid l'oid
	 * @param oid
	 * @return
	...
	public static Object[][] getOtherOrganisationIntoTab(String oid) {
		...
		for(int i =0;i<tabOrg.length;i++){
			// on regarde si l'organisation � pour membre l'individu, si non on l'ajoute � notre r�sultat
