...
public class ExpressIndividu {
	public static String createIndividu() {
		Oid oidUser = InterfaceExpressJava.createEntity(ExpressConstant.CORE_PACKAGE, ExpressConstant.PERSON_CLASS);
		return (oidUser.get());
	}
	...
	/**
	 * Cette m�thode retourne les organisations auquel appartient l'individu ayant
	 * pour oid l'oid
	 * 
	 * @param oid
	...
	public static Object[][] getOrganisationIntoTab(String oid) {
		...
		try {
			...
			Object[][] res = new Object[myOrga.size()][Organization.toArrayLenght()];
	...
	/**
	 * Cette m�thode retourne les organisation auquel l'individu n'appartient pas
	 * 
	 * @param oid
	 * @return les organisations {oid, name, statut, role, image path}
	 */
