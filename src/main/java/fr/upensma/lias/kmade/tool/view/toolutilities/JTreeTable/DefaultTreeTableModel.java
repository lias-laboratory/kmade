...
public class DefaultTreeTableModel extends AbstractTreeTableModel {
	...
	public Object getValueAt(Object node, int column) {
		/**
		 * @todo Implement this org.jdesktopx.swing.treetable.TreeTableModel abstract
		 *       method
		 */
	...
	protected TreeNode[] getPathToRoot(TreeNode node, int depth) {
		...
		/*
		 * Check for null, in case someone passed in a null node, or they passed in an
		 * element that isn't rooted at root.
		 */
		if (node == null) {
			if (depth == 0)
				return null;
